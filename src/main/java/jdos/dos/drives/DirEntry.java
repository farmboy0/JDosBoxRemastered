...
public class DirEntry {
    ...
    public void load(byte[] d, int off) {
        ...
        NTRes = p.readb(0);
        p.inc(1);
        milliSecondStamp = p.readb(0);
        p.inc(1);
        crtTime = p.readw(0);
        p.inc(2);
        crtDate = p.readw(0);
        p.inc(2);
        accessDate = p.readw(0);
        p.inc(2);
        hiFirstClust = p.readw(0);
        p.inc(2);
        modTime = p.readw(0);
        p.inc(2);
        modDate = p.readw(0);
        p.inc(2);
        loFirstClust = p.readw(0);
        p.inc(2);
        entrysize = p.readd(0);
    }
    ...
    public void save(byte[] d, int off) {
        ...
        p.writeb(0, NTRes);
        p.inc(1);
        p.writeb(0, milliSecondStamp);
        p.inc(1);
        p.writew(0, crtTime);
        p.inc(2);
        p.writew(0, crtDate);
        p.inc(2);
        p.writew(0, accessDate);
        p.inc(2);
        p.writew(0, hiFirstClust);
        p.inc(2);
        p.writew(0, modTime);
        p.inc(2);
        p.writew(0, modDate);
        p.inc(2);
        p.writew(0, loFirstClust);
        p.inc(2);
