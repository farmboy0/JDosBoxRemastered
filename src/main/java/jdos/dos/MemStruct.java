...
public class MemStruct {
    ...
    public /*Bitu*/int GetIt(/*Bitu*/int size, /*PhysPt*/int addr) {
        switch (size) {
            case 1:
                return Memory.mem_readb(pt + addr);
            case 2:
                return Memory.mem_readw(pt + addr);
            case 4:
                return Memory.mem_readd(pt + addr);
        }
        return 0;
    }
    ...
    public void SaveIt(/*Bitu*/int size,/*PhysPt*/int addr,/*Bitu*/int val) {
        switch (size) {
            case 1:
                ...
                break;
            case 2:
                Memory.mem_writew(pt + addr, (short) val);
                break;
            case 4:
                Memory.mem_writed(pt + addr, val);
                break;
        }
    }

    void SetPt(/*Bit16u*/int seg) {
    ...
    void SetRealPt(/*RealPt*/int addr) {
