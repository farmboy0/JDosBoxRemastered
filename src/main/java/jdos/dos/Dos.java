            ...
            switch (CPU_Regs.reg_eax.high() & 0xFF) {
                ...
                case 0x0f:        /* Open File using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x0f FCB-fileopen used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x10:        /* Close File using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x10 FCB-fileclose used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x11:        /* Find First Matching File using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x11 FCB-FindFirst used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x12:        /* Find Next Matching File using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x12 FCB-FindNext used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x13:        /* Delete File using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x16 FCB-Delete used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x14:        /* Sequential read from FCB */
                    CPU_Regs.reg_eax.low(Dos_files.DOS_FCBRead(CPU_Regs.reg_dsVal.dword, CPU_Regs.reg_edx.word(), 0));
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x14 FCB-Read used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x15:        /* Sequential write to FCB */
                    CPU_Regs.reg_eax.low(Dos_files.DOS_FCBWrite(CPU_Regs.reg_dsVal.dword, CPU_Regs.reg_edx.word(), 0));
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x15 FCB-Write used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                case 0x16:        /* Create or truncate file using FCB */
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x16 FCB-Create used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                ...
                case 0x21:        /* Read random record from FCB */ {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x21 FCB-Random read used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                }
                case 0x22:        /* Write random record to FCB */ {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x22 FCB-Random write used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                }
                ...
                case 0x27:        /* Random block read from FCB */ {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x27 FCB-Random(block) read used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                }
                case 0x28:        /* Random Block write to FCB */ {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:0x28 FCB-Random(block) write used, result:al=" + CPU_Regs.reg_eax.low());
                    break;
                }
                ...
                if (Log.level <= LogSeverities.LOG_NORMAL)
                    Log.log(LogTypes.LOG_FCB, LogSeverities.LOG_NORMAL, "DOS:29:FCB Parse Filename, result:al=" + CPU_Regs.reg_eax.low());
                break;
                ...
                case 0x2c:        /* Get System Time */
                    ...
                    /*Bitu*/
                    long time = (long) ((100.0 / ((double) Timer.PIT_TICK_RATE / 65536.0)) * (double) ticks);
                ...
                case 0x3a:        /* RMDIR Remove directory */ {
                    ...
                    if (Dos_files.DOS_RemoveDir(name1)) {
                        ...
                        Callback.CALLBACK_SCF(true);
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_MISC, LogSeverities.LOG_NORMAL, "Remove dir failed on " + name1 + " with error " + dos.errorcode);
                    }
                    break;
                }
                ...
                case 0x71:                    /* Unknown probably 4dos detection */
                    ...
                    Callback.CALLBACK_SCF(true);
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_DOSMISC, LogSeverities.LOG_NORMAL, "DOS:Windows long file name support call " + Integer.toString(CPU_Regs.reg_eax.low(), 16));
                    break;
        ...
        public /*Bitu*/int call() {
            ...
            if (drive >= Dos_files.Drives.length || Dos_files.Drives[CPU_Regs.reg_eax.low()] == null) {
                ...
                if ((CPU_Regs.reg_ecx.word() != 1) || (CPU_Regs.reg_edx.word() != 1))
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_DOSMISC, LogSeverities.LOG_NORMAL, "int 25 called but not as diskdetection drive " + Integer.toString(CPU_Regs.reg_eax.low(), 16));
