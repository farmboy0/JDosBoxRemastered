...
import jdos.gui.JDOSNativeKeyAdapter;
...
public class WinKeyboard {
    ...
    public static Main.KeyboardHandler defaultKeyboardHandler = key -> {
        ...
        switch (key.getKeyCode()) {
            ...
            case NativeKeyEvent.VC_1:
                result = isNumPadKey(key) ? 0x61 : 0x31;
                break;
            case NativeKeyEvent.VC_2:
                result = isNumPadKey(key) ? 0x62 : 0x32;
                break;
            case NativeKeyEvent.VC_3:
                result = isNumPadKey(key) ? 0x63 : 0x33;
                break;
            case NativeKeyEvent.VC_4:
                result = isNumPadKey(key) ? 0x64 : 0x34;
                break;
            case NativeKeyEvent.VC_5:
                result = isNumPadKey(key) ? 0x65 : 0x35;
                break;
            case NativeKeyEvent.VC_6:
                result = isNumPadKey(key) ? 0x66 : 0x36;
                break;
            case NativeKeyEvent.VC_7:
                result = isNumPadKey(key) ? 0x67 : 0x37;
                break;
            case NativeKeyEvent.VC_8:
                result = isNumPadKey(key) ? 0x68 : 0x38;
                break;
            case NativeKeyEvent.VC_9:
                result = isNumPadKey(key) ? 0x69 : 0x39;
                break;
            case NativeKeyEvent.VC_0:
                result = isNumPadKey(key) ? 0x60 : 0x30;
                break;
            case JDOSNativeKeyAdapter.VC_SUBTRACT:
                result = 0x6D;
                break;
            ...
            case JDOSNativeKeyAdapter.VC_LESS:
                break;
            ...
            case NativeKeyEvent.VC_SLASH:
                result = isNumPadKey(key) ? 0x6F : 0xBF;
                break;
            case JDOSNativeKeyAdapter.VC_PLUS:
                result = 0x6B;
                break;
            ...
            case NativeKeyEvent.VC_PRINTSCREEN:
                result = isNumPadKey(key) ? 0x6A : 0x2C;
                break;
            default:
    ...
    public static int win2java(int winVirtualKeyCode) {
        switch (winVirtualKeyCode) {
            ...
            case 0x6D:
                return JDOSNativeKeyAdapter.VC_SUBTRACT;
            ...
            //case 0x6A:
            //    return JDOSNativeKeyAdapter.VC_MULTIPLY;
            case 0x12:
            ...
            //case 0x6F:
            //    return JDOSNativeKeyAdapter.VC_DIVIDE;
            case 0x6B:
                return JDOSNativeKeyAdapter.VC_PLUS;
            case 0x24:
    ...
    private static boolean isNumPadKey(NativeKeyEvent key) {
