...
public class WAVEFORMATEX extends WinAPI {
    ...
    public WAVEFORMATEX(int address) {
        ...
        address += 2;
        nChannels = Memory.mem_readw(address);
        address += 2;
        nSamplesPerSec = Memory.mem_readd(address);
        address += 4;
        nAvgBytesPerSec = Memory.mem_readd(address);
        address += 4;
        nBlockAlign = Memory.mem_readw(address);
        address += 2;
        wBitsPerSample = Memory.mem_readw(address);
        address += 2;
    ...
    public void write(int address) {
        writew(address, wFormatTag);
        address += 2;
        writew(address, nChannels);
        address += 2;
        writed(address, nSamplesPerSec);
        address += 4;
        writed(address, nAvgBytesPerSec);
        address += 4;
        writew(address, nBlockAlign);
        address += 2;
        writew(address, wBitsPerSample);
        address += 2;
