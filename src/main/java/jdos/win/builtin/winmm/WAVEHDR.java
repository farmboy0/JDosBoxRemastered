...
public class WAVEHDR {
    ...
    public WAVEHDR(int address) {
        ...
        address += 4;
        dwBufferLength = Memory.mem_readd(address);
        address += 4;
        dwBytesRecorded = Memory.mem_readd(address);
        address += 4;
        dwUser = Memory.mem_readd(address);
        address += 4;
        dwFlags = Memory.mem_readd(address);
        address += 4;
        dwLoops = Memory.mem_readd(address);
        address += 4;
        lpNext = Memory.mem_readd(address);
        address += 4;
