...
public class Gdi32 extends BuiltinModule {
    public Gdi32(Loader loader, int handle) {
        ...
        add(BitBlt.class, "BitBlt", LOG_GDI ? new String[] { "hdcDest", "nXDest", "nYDest", "nWidth", "nHeight",
            "hdcSrc", "nXSrc", "nYSrc", "dwRop", "(BOOL)result" } : null);
        add(WinBitmap.class, "CreateBitmap",
            LOG_GDI ? new String[] { "nWidth", "nHeight", "cPlanes", "cBitsPerPel", "(HEX)lpvBits" } : null);
        ...
        add(WinFont.class, "CreateFontA",
            LOG_GDI ? new String[] { "nHeight", "nWidth", "nEscapement", "nOrientation", "fnWeight", "fdwItalic",
                "fdwUnderline", "fdwStrikeOut", "fdwCharSet", "fdwOutputPrecision", "fdwClipPrecision", "fdwQuality",
                "fdwPitchAndFamily", "(STRING)lpszFace" } : null);
        add(WinFont.class, "CreateFontW",
            LOG_GDI ? new String[] { "nHeight", "nWidth", "nEscapement", "nOrientation", "fnWeight", "fdwItalic",
                "fdwUnderline", "fdwStrikeOut", "fdwCharSet", "fdwOutputPrecision", "fdwClipPrecision", "fdwQuality",
                "fdwPitchAndFamily", "(STRINGW)lpszFace" } : null);
        ...
        add(WinPen.class, "ExtCreatePen", LOG_GDI ? new String[] { "(HEX)dwPenStyle", "dwWidth", "(HEX)lplb",
            "dwStyleCount", "(HEX)lpStyle" } : null);
        add(WinDC.class, "ExtTextOutA", LOG_GDI ? new String[] { "hdc", "X", "Y", "(HEX)fuOptions", "(RECT)lprc",
            "(STRINGN6)lpString", "cbCount", "(HEX)lpDx", "(BOOL)result" } : null);
        ...
        add(Dib.class, "GetDIBColorTable",
            LOG_GDI ? new String[] { "hdc", "uStartIndex", "cEntries", "(HEX)pColors" } : null);
        ...
        add(WinPalette.class, "GetPaletteEntries",
            LOG_GDI ? new String[] { "(GDI)hpal", "iStartIndex", "nEntries", "(HEX)lppe" } : null);
        ...
        add(WinDC.class, "GetSystemPaletteEntries",
            LOG_GDI ? new String[] { "hdc", "iStartIndex", "nEntries", "lppe" } : null);
        ...
        add(WinFont.class, "GetTextExtentExPointA", LOG_GDI ? new String[] { "hdc", "(STRINGN2)lpszStr", "cchString",
            "nMaxExtent", "(HEX)lpnFit", "(HEX)alpDx", "(HEX)lpSize", "(BOO)result", "06(SIZE)lpSize" } : null);
        add(WinFont.class, "GetTextExtentPoint32A", LOG_GDI ? new String[] { "hdc", "(STRINGN2)lpString", "cbString",
            "(HEX)lpSize", "result", "03(SIZE)lpSize" } : null);
        add(WinFont.class, "GetTextExtentPointA", LOG_GDI ? new String[] { "hdc", "(STRINGN2)lpString", "cbString",
            "(HEX)lpSize", "result", "03(SIZE)lpSize" } : null);
        add(WinFont.class, "GetTextMetricsA",
            LOG_GDI ? new String[] { "hdc", "(HEX)lptm", "(BOOL)result", "01(TM)lptm" } : null);
        add(Clipping.class, "IntersectClipRect",
            LOG_GDI ? new String[] { "hdc", "nLeftRect", "nTopRect", "nRightRect", "nBottomRect" } : null);
        add(PaintingGDI.class, "LineTo", LOG_GDI ? new String[] { "hdc", "nXEnd", "nYEnd", "(BOOL)result" } : null);
        add(PaintingGDI.class, "MoveToEx",
            LOG_GDI ? new String[] { "hdc", "X", "Y", "(HEX)lpPoint", "(BOOL)result", "03(POINT)lpPoint" } : null);
        add(Mapping.class, "OffsetViewportOrgEx", LOG_GDI ? new String[] { "hdc", "nXOffset", "nYOffset",
            "(HEX)lpPoint", "(BOOL)result", "03(POINT)lpPoint" } : null);
        add(PaintingGDI.class, "Polygon",
            LOG_GDI ? new String[] { "hdc", "(POINT)lpPoints", "nCount", "(BOOL)result" } : null);
        ...
        add(WinDC.class, "SelectPalette",
            LOG_GDI ? new String[] { "hdc", "(GDI)hpal", "(BOOL)bForceBackground", "(GDI)result" } : null);
        ...
        add(Dib.class, "SetDIBitsToDevice",
            LOG_GDI ? new String[] { "hdc", "XDest", "YDest", "nDestWidth", "nDestHeight", "XSrc", "YSrc", "uStartScan",
                "cScanLines", "(HEX)lpBits", "(HEX)lpBitsInfo", "iUsage" } : null);
        add(WinPalette.class, "SetPaletteEntries",
            LOG_GDI ? new String[] { "(GDI)hpal", "iStart", "cbEntries", "(HEX)lppe" } : null);
        ...
        add(BitBlt.class, "StretchBlt",
            LOG_GDI ? new String[] { "hdcDest", "nXOriginDest", "nYOriginDest", "nWidthDest", "nHeightDest", "hdcSrc",
                "nXOriginSrc", "nYOriginSrc", "nWidthSrc", "nHeightSrc", "(HEX)dwRop" } : null);
        add(Dib.class, "StretchDIBits",
            LOG_GDI ? new String[] { "hdc", "XDest", "YDest", "nDestWidth", "nDestHeight", "XSrc", "YSrc", "nSrcWidth",
                "nSrcHeight", "(HEX)lpBits", "(HEX)lpBitsInfo", "iUsage", "(HEX)dwRop" } : null);
