...
public class KPath extends WinAPI {
    ...
    public static int GetSystemDirectoryA(int lpBuffer, int uSize) {
    ...
    public static int SearchPathA(int lpPath, int lpFileName, int lpExtension, int nBufferLength, int lpBuffer,
        int lpFilePart) {
    ...
    public static int SetCurrentDirectoryA(int lpPathName) {
