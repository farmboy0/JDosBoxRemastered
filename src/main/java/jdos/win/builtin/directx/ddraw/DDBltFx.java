...
public class DDBltFx {
    ...
    public DDBltFx(int address) {
        size = Memory.mem_readd(address);
        address += 4;
        dwDDFX = Memory.mem_readd(address);
        address += 4;
        dwROP = Memory.mem_readd(address);
        address += 4;
        dwDDROP = Memory.mem_readd(address);
        address += 4;
        dwRotationAngle = Memory.mem_readd(address);
        address += 4;
        dwZBufferOpCode = Memory.mem_readd(address);
        address += 4;
        dwZBufferLow = Memory.mem_readd(address);
        address += 4;
        dwZBufferHigh = Memory.mem_readd(address);
        address += 4;
        dwZBufferBaseDest = Memory.mem_readd(address);
        address += 4;
        dwZDestConstBitDepth = Memory.mem_readd(address);
        address += 4;
        dwZDestConst = Memory.mem_readd(address);
        address += 4;
        dwZSrcConstBitDepth = Memory.mem_readd(address);
        address += 4;
        dwZSrcConst = Memory.mem_readd(address);
        address += 4;
        dwAlphaEdgeBlendBitDepth = Memory.mem_readd(address);
        address += 4;
        dwAlphaEdgeBlend = Memory.mem_readd(address);
        address += 4;
        dwReserved = Memory.mem_readd(address);
        address += 4;
        dwAlphaDestConstBitDepth = Memory.mem_readd(address);
        address += 4;
        dwAlphaDestConst = Memory.mem_readd(address);
        address += 4;
        dwAlphaSrcConstBitDepth = Memory.mem_readd(address);
        address += 4;
        dwAlphaSrcConst = Memory.mem_readd(address);
        address += 4;
        dwFillColor = Memory.mem_readd(address);
        address += 4;
        ddckDestColorkey = new DDColorKey(address);
        address += DDColorKey.SIZE;
