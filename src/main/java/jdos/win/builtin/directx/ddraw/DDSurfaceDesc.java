...
public class DDSurfaceDesc {
    ...
    public static final int SIZE2 = 0x7C;
    ...
    public static final int DDSD_CKDESTOVERLAY = 0x00002000;
    public static final int DDSD_CKDESTBLT = 0x00004000;
    public static final int DDSD_CKSRCOVERLAY = 0x00008000;
    public static final int DDSD_CKSRCBLT = 0x00010000;
    public static final int DDSD_MIPMAPCOUNT = 0x00020000;
    public static final int DDSD_REFRESHRATE = 0x00040000;
    public static final int DDSD_LINEARSIZE = 0x00080000;
    public static final int DDSD_TEXTURESTAGE = 0x00100000;
    public static final int DDSD_FVF = 0x00200000;
    public static final int DDSD_SRCVBHANDLE = 0x00400000;
    public static final int DDSD_DEPTH = 0x00800000;
    public static final int DDSD_ALL = 0x00fff9ee;
