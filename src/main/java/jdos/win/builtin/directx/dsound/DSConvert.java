...
public class DSConvert extends WinAPI {
    static private final bitsconvertfunc convert_8_to_16 = new bitsconvertfunc() {
    ...
    static private final bitsconvertfunc convert_16_to_16 = new bitsconvertfunc() {
        public void call(int s, Ptr dst, int src_stride, int dst_stride, int c, int f, int adj) {
            IntRef count = new IntRef(c);
            IntRef src = new IntRef(s);
            IntRef freqAcc = new IntRef(f);
    ...
    static private final bitsconvertfunc convert_24_to_16 = new bitsconvertfunc() {
        public void call(int s, Ptr dst, int src_stride, int dst_stride, int c, int f, int adj) {
            IntRef count = new IntRef(c);
            IntRef src = new IntRef(s);
            IntRef freqAcc = new IntRef(f);
    ...
    static private final bitsconvertfunc convert_32_to_16 = new bitsconvertfunc() {
        public void call(int s, Ptr dst, int src_stride, int dst_stride, int c, int f, int adj) {
            IntRef count = new IntRef(c);
            IntRef src = new IntRef(s);
            IntRef freqAcc = new IntRef(f);
    ...
    static private final bitsconvertfunc convert_ieee_32_to_16 = new bitsconvertfunc() {
        public void call(int s, Ptr dst, int src_stride, int dst_stride, int c, int f, int adj) {
            IntRef count = new IntRef(c);
            IntRef src = new IntRef(s);
            IntRef freqAcc = new IntRef(f);
