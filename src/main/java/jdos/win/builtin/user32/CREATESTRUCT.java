...
public class CREATESTRUCT extends WinAPI {
    ...
    public CREATESTRUCT(int address) {
        ...
        address += 4;
        hInstance = readd(address);
        address += 4;
        hMenu = readd(address);
        address += 4;
        hwndParent = readd(address);
        address += 4;
        cy = readd(address);
        address += 4;
        cx = readd(address);
        ...
        style = readd(address);
        address += 4;
        lpszName = readd(address);
        address += 4;
        lpszClass = readd(address);
        address += 4;
    ...
    static public void write(int address, int lpCreateParams, int hInstance, int hMenu, int hwndParent, int cy, int cx, int y, int x, int style, int lpszName, int lpszClass, int dwExStyle) {
        ...
        address += 4;
        writed(address, hMenu);
        address += 4;
        writed(address, hwndParent);
        address += 4;
        writed(address, cy);
        address += 4;
        writed(address, cx);
        ...
        address += 4;
        writed(address, lpszName);
        address += 4;
        writed(address, lpszClass);
        address += 4;
