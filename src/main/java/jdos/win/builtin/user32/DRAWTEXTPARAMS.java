...
public class DRAWTEXTPARAMS extends WinAPI {
    ...
    public DRAWTEXTPARAMS(int address) {
        ...
        address += 4;
        iTabLength = readd(address);
        address += 4;
        iLeftMargin = readd(address);
        address += 4;
        iRightMargin = readd(address);
        address += 4;
    ...
    public void write(int address) {
        writed(address, cbSize);
        address += 4;
        writed(address, iTabLength);
        address += 4;
        writed(address, iLeftMargin);
        address += 4;
        writed(address, iRightMargin);
        address += 4;
