...
public class StaticWindow extends WinAPI {
    ...
    static private final StaticPaint STATIC_PaintOwnerDrawfn = new StaticPaint() {
    ...
    static private final StaticPaint STATIC_PaintTextfn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
            int format;
    ...
    static private final StaticPaint STATIC_PaintRectfn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
            int rc = getTempBuffer(WinRect.SIZE);
            int hBrush;
    ...
    static private final StaticPaint STATIC_PaintIconfn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
            int rc = getTempBuffer(WinRect.SIZE);
            WinPos.GetClientRect(hWnd, rc);
            int hbrush = STATIC_SendWmCtlColorStatic(hWnd, hdc);
    ...
    static private final StaticPaint STATIC_PaintBitmapfn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
    ...
    static private final StaticPaint STATIC_PaintEnhMetafn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
            int rc = getTempBuffer(WinRect.SIZE);
            WinPos.GetClientRect(hWnd, rc);
            int hbrush = STATIC_SendWmCtlColorStatic(hWnd, hdc);
    ...
    static private final StaticPaint STATIC_PaintEtchedfn = new StaticPaint() {
        public void paint(int hWnd, int hdc, int style) {
            int rc = getTempBuffer(WinRect.SIZE);
