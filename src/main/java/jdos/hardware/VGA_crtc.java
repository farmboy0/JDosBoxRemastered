                ...
                default:
                    if (VGA.svga.write_p3d5 != null) {
                        ...
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:Write to unknown index " + Integer.toString(VGA.vga.crtc.index, 16));
                    }
                    break;
            }
        }
            ...
            switch (VGA.vga.crtc.index) {
                ...
                default:
                    if (VGA.svga.read_p3d5 != null) {
                        ...
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:Read from unknown index " + Integer.toString(VGA.vga.crtc.index, 16));
                        return 0x0;
                    }
            }
        }
