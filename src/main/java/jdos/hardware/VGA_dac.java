...
public class VGA_dac {
    ...
    */
    ...
    static private final IoHandler.IO_WriteHandler write_p3c6 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            if (VGA.vga.dac.pel_mask != val) {
                if (Log.level <= LogSeverities.LOG_NORMAL)
                    Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:DCA:Pel Mask set to " + Integer.toString(val, 16));
    ...
    static private final IoHandler.IO_ReadHandler read_p3c6 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return VGA.vga.dac.pel_mask;
        }
    };
    static private final IoHandler.IO_WriteHandler write_p3c7 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
    ...
    static private final IoHandler.IO_ReadHandler read_p3c7 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            if (VGA.vga.dac.state == DAC_READ) return 0x3;
            else return 0x0;
        }
    };
    static private final IoHandler.IO_WriteHandler write_p3c8 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
    ...
    static private final IoHandler.IO_ReadHandler read_p3c8 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return VGA.vga.dac.write_index;
        }
    };
    static private final IoHandler.IO_WriteHandler write_p3c9 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            val &= 0x3f;
    ...
    static private final IoHandler.IO_ReadHandler read_p3c9 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            /*Bitu*/
            short ret;
            switch (VGA.vga.dac.pel_index) {
