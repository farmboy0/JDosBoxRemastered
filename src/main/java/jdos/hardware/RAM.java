...
final public class RAM {
    ...
    public static void memcpy(int dest, byte[] src, int srcOffset, /*Bitu*/int size) {
        for (int i = 0; i < size; i++)
            writeb(dest++, src[srcOffset++]);
    }

    public static void memcpy(byte[] dest, int dest_offset, /*PhysPt*/int src, /*Bitu*/int size) {
        int begin = src & 3;
        int end = size & ~3;
    ...
    public static void memcpy(Render.Render_t.SRC dst, int offset, /*PhysPt*/int src, /*Bitu*/int amount) {
    ...
    public static void memcpy(/*PhysPt*/int dst, /*PhysPt*/int src, /*Bitu*/int amount) {
    ...
    public static void zeroset(int dest, int size) {
        memset(dest, size, 0);
    }

    public static void memset(int dest, int size, int value) {
        if ((dest & 0x3) == 0) {
            int index = dest >>> 2;
            int len = size >>> 2;
            value &= 0xFF;
