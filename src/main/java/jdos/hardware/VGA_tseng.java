...
public class VGA_tseng {
    ...
    static private final VGA.tWritePort write_p3d5_et4k = new VGA.tWritePort() {
            ...
            */
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
...
//            return et4k.store_##port##_##index;
    static private final VGA.tReadPort read_p3d5_et4k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            ...
            switch (reg) {
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    };
    static private final VGA.tWritePort write_p3c5_et4k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
            switch (reg) {
            /*
            ...
            */
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:SEQ:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
    static private final VGA.tReadPort read_p3c5_et4k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            switch (reg) {
                case 0x06:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:SEQ:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    };
    static private final VGA.tWritePort write_p3cd_et4k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
    ...
    */
    ...
    static private final IoHandler.IO_ReadHandler read_p3cd_et4k = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return (VGA.vga.svga.bank_read << 4) | VGA.vga.svga.bank_write;
        }
    };
    static private final VGA.tWritePort write_p3c0_et4k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
            switch (reg) {
            ...
            */
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:ET4K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
    static private final VGA.tReadPort read_p3c1_et4k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            switch (reg) {
                case 0x16:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:ET4K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    };
    private static final VGA.tFinishSetMode FinishSetMode_ET4K = new VGA.tFinishSetMode() {
    ...
    */
    static private final VGA.tDetermineMode DetermineMode_ET4K = new VGA.tDetermineMode() {
        public void call() {
    ...
    static private final VGA.tSetClock SetClock_ET4K = new VGA.tSetClock() {
        public void call(/*Bitu*/int which,/*Bitu*/int target) {
            et4k.clockFreq[which] = 1000 * target;
            VGA.VGA_StartResize();
        }
    };
    static private final VGA.tGetClock GetClock_ET4K = new VGA.tGetClock() {
        public /*Bitu*/int call() {
            return et4k.clockFreq[get_clock_index_et4k()];
        }
    };
    static private final VGA.tAcceptsMode AcceptsMode_ET4K = new VGA.tAcceptsMode() {
    ...
    static private final VGA.tWritePort write_p3d5_et3k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
            switch (reg) {
            ...
            */
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
    static private final VGA.tReadPort read_p3d5_et3k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            switch (reg) {
                case 0x1b:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:CRTC:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    };
    static private final VGA.tWritePort write_p3c5_et3k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
            switch (reg) {
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:SEQ:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
    static private final VGA.tReadPort read_p3c5_et3k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            switch (reg) {
                case 0x06:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:SEQ:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    ...
    */
    static private final IoHandler.IO_WriteHandler write_p3cd_et3k = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
...
//            return et3k.store_##port##_##index;
    static private final IoHandler.IO_ReadHandler read_p3cd_et3k = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return (VGA.vga.svga.bank_read << 3) | VGA.vga.svga.bank_write | ((VGA.vga.svga.bank_size == 128 * 1024) ? 0 : 0x40);
        }
    };
    static private final VGA.tWritePort write_p3c0_et3k = new VGA.tWritePort() {
        public void call(/*Bitu*/int reg,/*Bitu*/int val,/*Bitu*/int iolen) {
            // See ET4K notes.
            switch (reg) {
                case 0x16:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:ET3K:Write to illegal index " + Integer.toString(reg, 16));
                    break;
            }
        }
    };
    static private final VGA.tReadPort read_p3c1_et3k = new VGA.tReadPort() {
        public /*Bitu*/int call(/*Bitu*/int reg,/*Bitu*/int iolen) {
            switch (reg) {
                case 0x16:
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:ET3K:Read from illegal index " + Integer.toString(reg, 16));
                    break;
            }
            return 0x0;
        }
    };
    static private final VGA.tFinishSetMode FinishSetMode_ET3K = new VGA.tFinishSetMode() {
        public void call(/*Bitu*/int crtc_base, VGA.VGA_ModeExtraData modeData) {
    ...
    static private final VGA.tDetermineMode DetermineMode_ET3K = new VGA.tDetermineMode() {
        public void call() {
            // Close replica from the base implementation. It will stay here
            // until I figure a way to either distinguish M_VGA and M_LIN8 or
            // merge them.
    ...
    static private final VGA.tSetClock SetClock_ET3K = new VGA.tSetClock() {
        public void call(/*Bitu*/int which,/*Bitu*/int target) {
            et3k.clockFreq[which] = 1000 * target;
            VGA.VGA_StartResize();
        }
    };
    static private final VGA.tGetClock GetClock_ET3K = new VGA.tGetClock() {
        public /*Bitu*/int call() {
            return et3k.clockFreq[get_clock_index_et3k()];
        }
    };
    static private final VGA.tAcceptsMode AcceptsMode_ET3K = new VGA.tAcceptsMode() {
