...
public class VGA_seq {
    private static final IoHandler.IO_ReadHandler read_p3c4 = (port, iolen) -> VGA.vga.seq.index;
                ...
                if (VGA.svga.write_p3c5 != null) {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL,
                            "VGA:SEQ:Write to illegal index " + Integer.toString(VGA.vga.seq.index, 16));
                }
                break;
        }
    };

    private static final IoHandler.IO_ReadHandler read_p3c5 = (port, iolen) -> {
