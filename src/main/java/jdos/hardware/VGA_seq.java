...
public class VGA_seq {
    static private final IoHandler.IO_ReadHandler read_p3c4 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return VGA.vga.seq.index;
        }
    };

    private static final IoHandler.IO_WriteHandler write_p3c4 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            VGA.vga.seq.index = (short) val;
        }
    };

    private static final IoHandler.IO_WriteHandler write_p3c5 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
                ...
                default:
                    if (VGA.svga.write_p3c5 != null) {
                        ...
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:SEQ:Write to illegal index " + Integer.toString(VGA.vga.seq.index, 16));
                    }
                    break;
            }
        }
    ...
    static private final IoHandler.IO_ReadHandler read_p3c5 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
