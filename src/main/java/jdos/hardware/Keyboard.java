...
public class Keyboard {
    ...
    private static final Pic.PIC_EventHandler KEYBOARD_ResetDelay = new Pic.PIC_EventHandler() {
    ...
    private static final IoHandler.IO_ReadHandler read_p60 = new IoHandler.IO_ReadHandler() {
    ...
    private static final IoHandler.IO_WriteHandler write_p60 = new IoHandler.IO_WriteHandler() {
    ...
    private static final IoHandler.IO_ReadHandler read_p61 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            port_61_data ^= 0x20;
            port_61_data ^= 0x10;
            return port_61_data;
    ...
    private static final IoHandler.IO_WriteHandler write_p61 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
    ...
    private static final IoHandler.IO_WriteHandler write_p64 = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (val) {
    ...
    private static final IoHandler.IO_ReadHandler read_p64 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return keyb.status | (keyb.p60changed ? 0x1 : 0x0) | (keyb.auxchanged ? 0x20 : 0x00);
        }
    };
    static private final Timer.TIMER_TickHandler KEYBOARD_TickHandler = new Timer.TIMER_TickHandler() {
        public void call() {
