...
public class IoHandler {
    ...
    static private final IO_ReadHandler IO_ReadBlocked = new IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return ~0;
        }
    };
    static private final IO_WriteHandler IO_WriteBlocked = new IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
        }
    };
    static private final IO_ReadHandler IO_ReadDefault = new IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            switch (iolen) {
                case 1:
    ...
    static private final IO_WriteHandler IO_WriteDefault = new IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (iolen) {
                case 1:
                    if (Log.level <= LogSeverities.LOG_WARN)
