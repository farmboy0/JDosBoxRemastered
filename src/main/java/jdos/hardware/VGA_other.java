...
public class VGA_other {
    private static final IoHandler.IO_WriteHandler write_crtc_index_other = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            VGA.vga.other.index = (short) val;
        }
    };

    private static final IoHandler.IO_ReadHandler read_crtc_index_other = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return VGA.vga.other.index;
        }
    };

    private static final IoHandler.IO_WriteHandler write_crtc_data_other = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (VGA.vga.other.index) {
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "MC6845:Write " + Integer.toString(val, 16) + " to illegal index " + Integer.toString(VGA.vga.other.index, 16));
            }
        }
    };

    private static final IoHandler.IO_ReadHandler read_crtc_data_other = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            switch (VGA.vga.other.index) {
                case 0x00:        //Horizontal total
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "MC6845:Read from illegal index " + Integer.toString(VGA.vga.other.index, 16));
            }
            /*Bitu*/
            return ~0;
        }
    ...
    private static final IoHandler.IO_WriteHandler write_lightpen = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (port) {
    ...
    private static final Mapper.MAPPER_Handler IncreaseHue = new Mapper.MAPPER_Handler() {
    ...
    private static final Mapper.MAPPER_Handler DecreaseHue = new Mapper.MAPPER_Handler() {
        public void call(boolean pressed) {
            if (!pressed)
                return;
            hue_offset -= 5.0;
    ...
    private static final IoHandler.IO_WriteHandler write_cga = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (port) {
                case 0x3d8:
    ...
    private static final IoHandler.IO_WriteHandler write_tandy = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (port) {
                case 0x3d8:
                ...
                case 0x3d9:
                    ...
                    if (VGA.vga.mode == VGA.M_TANDY2)
                        VGA.vga.attr.palette[0xf] = (short) (VGA.vga.tandy.color_select & 0xf);
    ...
    private static final IoHandler.IO_WriteHandler write_pcjr = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (port) {
                case 0x3da:
    ...
    private static final Mapper.MAPPER_Handler CycleHercPal = new Mapper.MAPPER_Handler() {
        public void call(boolean pressed) {
            if (!pressed) return;
    ...
    private static final IoHandler.IO_WriteHandler write_hercules = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (port) {
                case 0x3b8: {
    ...
    private static final IoHandler.IO_ReadHandler read_herc_status = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            ...
            double timeInFrame = Pic.PIC_FullIndex() - VGA.vga.draw.delay.framestart;
            /*Bit8u*/
            short retval = 0x72; // Hercules ident; from a working card (Winbond W86855AF)
        ...
        switch (VGA.vga.tandy.reg_index) {
            case 0x0:
                if (Dosbox.machine == MachineType.MCH_PCJR) {
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "Unhandled Write " + Integer.toString(val, 16) + " to tandy reg " + Integer.toString(VGA.vga.tandy.reg_index, 16));
                }
                break;
