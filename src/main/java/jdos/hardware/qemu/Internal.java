...
public class Internal {
    ...
    public static final boolean DEBUG_IDE_ATAPI = false;
    public static final boolean DEBUG_AIO = true;
    public static final boolean USE_DMA_CDROM = true;

    public static final String TYPE_IDE_BUS = "IDE";
    ...
    /* Bits for HD_ERROR */
    public static final int MARK_ERR = 0x01; /* Bad address mark */
    public static final int TRK0_ERR = 0x02; /* couldn't find track 0 */
    public static final int ABRT_ERR = 0x04; /* Command aborted */
    public static final int MCR_ERR = 0x08; /* media change request */
    public static final int ID_ERR = 0x10; /* ID field not found */
    public static final int MC_ERR = 0x20; /* media changed */
    public static final int ECC_ERR = 0x40; /* Uncorrectable ECC error */
    public static final int BBD_ERR = 0x80; /* pre-EIDE meaning:  block marked bad */
    public static final int ICRC_ERR = 0x80; /* new meaning:  CRC error during transfer */

    /* Bits of HD_NSECTOR */
    public static final int CD = 0x01;
    public static final int IO = 0x02;
    public static final int REL = 0x04;
    public static final int TAG_MASK = 0xf8;
    ...
    /* reserved                                         0x04..0x05 */
    public static final int WIN_DSM = 0x06;
    /* reserved                                         0x07 */
    public static final int WIN_DEVICE_RESET = 0x08;
    /* reserved                                         0x09..0x0a */
    /* REQUEST SENSE DATA EXT                           0x0B */
    /* reserved                                         0x0C..0x0F */
    public static final int WIN_RECAL = 0x10; /* obsolete since ATA4 */
    /* obsolete since ATA3, retired in ATA4             0x11..0x1F */
    public static final int WIN_READ = 0x20; /* 28-Bit */
    public static final int WIN_READ_ONCE = 0x21; /* 28-Bit w/o retries, obsolete since ATA5 */
    ...
    public static final int WIN_READDMA_QUEUED_EXT = 0x26; /* 48-Bit, obsolete since ACS2 */
    ...
    public static final int WIN_WRITE_ONCE = 0x31; /* 28-Bit w/o retries, obsolete since ATA5 */
    ...
    public static final int WIN_SET_MAX_EXT = 0x37; /* 48-Bit, obsolete since ACS2 */
    ...
    public static final int WIN_WRITE_VERIFY = 0x3C; /* 28-Bit, obsolete since ATA4 */
    /* WRITE DMA FUA EXT                                0x3D */
    /* obsolete since ACS2                              0x3E */
    /* WRITE LOG EXT                                    0x3F */
    public static final int WIN_VERIFY = 0x40; /* 28-Bit - Read Verify Sectors */
    public static final int WIN_VERIFY_ONCE = 0x41; /* 28-Bit - w/o retries, obsolete since ATA5 */
    ...
    /* reserved                                         0x62->0x6F */
    public static final int WIN_SEEK = 0x70; /* obsolete since ATA7 */
    /* reserved                                         0x71-0x7F */
    ...
    public static final int WIN_SPECIFY = 0x91; /* set drive geometry translation, obsolete since ATA6 */
    public static final int WIN_DOWNLOAD_MICROCODE = 0x92;
    /* DOWNLOAD MICROCODE DMA                           0x93 */
    public static final int WIN_STANDBYNOW2 = 0x94; /* retired in ATA4 */
    public static final int WIN_IDLEIMMEDIATE2 = 0x95; /* force drive to become "ready", retired in ATA4 */
    public static final int WIN_STANDBY2 = 0x96; /* retired in ATA4 */
    public static final int WIN_SETIDLE2 = 0x97; /* retired in ATA4 */
    public static final int WIN_CHECKPOWERMODE2 = 0x98; /* retired in ATA4 */
    public static final int WIN_SLEEPNOW2 = 0x99; /* retired in ATA4 */
    ...
    public static final int WIN_QUEUED_SERVICE = 0xA2; /* obsolete since ACS2 */
    /* reserved                                         0xA3..0xAF */
    ...
    public static final int CFA_ACCESS_METADATA_STORAGE = 0xB8;
    /* reserved                                         0xBC..0xBF */
    public static final int CFA_ERASE_SECTORS = 0xC0; /* microdrives implement as NOP */
    /* vendor specific                                  0xC1..0xC3 */
    public static final int WIN_MULTREAD = 0xC4; /* read sectors using multiple mode*/
    public static final int WIN_MULTWRITE = 0xC5; /* write sectors using multiple mode */
    public static final int WIN_SETMULT = 0xC6; /* enable/disable multiple mode */
    public static final int WIN_READDMA_QUEUED = 0xC7; /* read sectors using Queued DMA transfers, obsolete since ACS2 */
    public static final int WIN_READDMA = 0xC8; /* read sectors using DMA transfers */
    public static final int WIN_READDMA_ONCE = 0xC9; /* 28-Bit - w/o retries, obsolete since ATA5 */
    public static final int WIN_WRITEDMA = 0xCA; /* write sectors using DMA transfers */
    public static final int WIN_WRITEDMA_ONCE = 0xCB; /* 28-Bit - w/o retries, obsolete since ATA5 */
    public static final int WIN_WRITEDMA_QUEUED = 0xCC; /* write sectors using Queued DMA transfers, obsolete since ACS2 */
    ...
    /* reserved                                         0xD5..0xD9 */
    public static final int WIN_GETMEDIASTATUS = 0xDA; /* obsolete since ATA8 */
    /* obsolete since ATA3, retired in ATA4             0xDB..0xDD */
    public static final int WIN_DOORLOCK = 0xDE; /* lock door on removable drives, obsolete since ATA8 */
    public static final int WIN_DOORUNLOCK = 0xDF; /* unlock door on removable drives, obsolete since ATA8 */
    ...
    public static final int WIN_MEDIAEJECT = 0xED; /* obsolete since ATA8 */
    /* obsolete since ATA4                              0xEE */
    public static final int WIN_SETFEATURES = 0xEF; /* set special drive features */
    public static final int IBM_SENSE_CONDITION = 0xF0; /* measure disk temperature, vendor specific */
    ...
    public static final int CFA_WEAR_LEVEL = 0xF5; /* microdrives implement as NOP; not specified in T13! */
    public static final int WIN_SECURITY_DISABLE = 0xF6;
    /* vendor specific                                  0xF7 */
    public static final int WIN_READ_NATIVE_MAX = 0xF8; /* return the native maximum address */
    ...
    public static final int IDE_DMA_BUF_SECTORS = 256;

    /* feature values for Data Set Management */
    public static final int DSM_TRIM = 0x01;
    ...
    public static final int GPCMD_MODE_SENSE_6 = 0x1a;
    ...
    public static final int ASC_MEDIUM_MAY_HAVE_CHANGED = 0x28;
    public static final int ASC_INCOMPATIBLE_FORMAT = 0x30;
    public static final int ASC_MEDIUM_NOT_PRESENT = 0x3a;
    public static final int ASC_SAVING_PARAMETERS_NOT_SUPPORTED = 0x39;
    public static final int ASC_MEDIA_REMOVAL_PREVENTED = 0x53;

    public static final int CFA_NO_ERROR = 0x00;
    public static final int CFA_MISC_ERROR = 0x09;
    public static final int CFA_INVALID_COMMAND = 0x20;
    public static final int CFA_INVALID_ADDRESS = 0x21;
    public static final int CFA_ADDRESS_OVERFLOW = 0x2f;

    public static final int SMART_READ_DATA = 0xd0;
    public static final int SMART_READ_THRESH = 0xd1;
    public static final int SMART_ATTR_AUTOSAVE = 0xd2;
    public static final int SMART_SAVE_ATTR = 0xd3;
    public static final int SMART_EXECUTE_OFFLINE = 0xd4;
    public static final int SMART_READ_LOG = 0xd5;
    public static final int SMART_WRITE_LOG = 0xd6;
    public static final int SMART_ENABLE = 0xd8;
    public static final int SMART_DISABLE = 0xd9;
    public static final int SMART_STATUS = 0xda;

    public static final int IDE_HD = 0;
    public static final int IDE_CD = 1;
    public static final int IDE_CFATA = 2;
    public static final String TYPE_IDE_DEVICE = "ide-device";
    public static final int BM_STATUS_DMAING = 0x01;
    public static final int BM_STATUS_ERROR = 0x02;
    public static final int BM_STATUS_INT = 0x04;
    /* FIXME These are not status register bits */
    public static final int BM_STATUS_DMA_RETRY = 0x08;
    public static final int BM_STATUS_PIO_RETRY = 0x10;
    public static final int BM_STATUS_RETRY_READ = 0x20;
    public static final int BM_STATUS_RETRY_FLUSH = 0x40;
    public static final int BM_STATUS_RETRY_TRIM = 0x80;
    public static final int BM_MIGRATION_COMPAT_STATUS_BITS = BM_STATUS_DMA_RETRY | BM_STATUS_PIO_RETRY
        | BM_STATUS_RETRY_READ | BM_STATUS_RETRY_FLUSH;
    public static final int BM_CMD_START = 0x01;
//    public static final int IDE_DEVICE(obj) \
//         OBJECT_CHECK(IDEDevice, (obj), TYPE_IDE_DEVICE)
//    public static final int IDE_DEVICE_CLASS(klass) \
//         OBJECT_CLASS_CHECK(IDEDeviceClass, (klass), TYPE_IDE_DEVICE)
//    public static final int IDE_DEVICE_GET_CLASS(obj) \
...
//    } IDEDeviceClass;
    public static final int BM_CMD_READ = 0x08;

    public static IDEState idebus_active_if(IDEBus bus) {
        return bus.ifs[bus.unit];
    }

    public static void ide_set_irq(IDEBus bus) {
        if ((bus.cmd & IDE_CMD_DISABLE_IRQ) == 0) {
            Pic.PIC_ActivateIRQ(bus.irq);
        }
    }

    public static int readw(byte[] b, int offset) {
        return b[offset] & 0xFF | (b[offset + 1] & 0xFF) << 8;
    }

    public static int readd(byte[] b, int offset) {
    ...
    public enum ide_dma_cmd {
        IDE_DMA_READ, IDE_DMA_WRITE, IDE_DMA_TRIM,
    }
...
//
//    public static final int VMSTATE_IDE_BUS(_field, _state)                          \
//        VMSTATE_STRUCT(_field, _state, 1, vmstate_ide_bus, IDEBus)
//
//    public static final int VMSTATE_IDE_BUS_ARRAY(_field, _state, _num)              \
//        VMSTATE_STRUCT_ARRAY(_field, _state, _num, 1, vmstate_ide_bus, IDEBus)
//
//    extern const VMStateDescription vmstate_ide_drive;
//
//    public static final int VMSTATE_IDE_DRIVES(_field, _state) \
//        VMSTATE_STRUCT_ARRAY(_field, _state, 2, 3, vmstate_ide_drive, IDEState)
    ...
    public static class unreported_events {
        public boolean eject_request;
        public boolean new_media;
    }

    /* NOTE: IDEState represents in fact one drive */
    public static final class IDEState {
        public IDEBus bus;
        public int unit;
        /* ide config */
        ...
        public boolean ide_cmd_is_read() {
            return dma_cmd == ide_dma_cmd.IDE_DMA_READ;
        }
    }

    public static class IDEDMAOps {
