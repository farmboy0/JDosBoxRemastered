...
public class Cmos extends Module_base {
    ...
    static private final IoHandler.IO_WriteHandler cmos_selreg = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            cmos.reg = (byte) (val & 0x3f);
            cmos.nmi = (val & 0x80) > 0;
        }
    };
    static private final IoHandler.IO_WriteHandler cmos_writereg = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            switch (cmos.reg) {
                case 0x00:        /* Seconds */
                case 0x02:        /* Minutes */
                ...
                case 0x0b:        /* Status reg B */
                    ...
                    if ((val & 0x10) != 0)
                        Log.log(LogTypes.LOG_BIOS, LogSeverities.LOG_ERROR, "CMOS:Updated ended interrupt not supported yet");
                    cmos_checktimer();
                    break;
    ...
    static private final IoHandler.IO_ReadHandler cmos_readreg = new IoHandler.IO_ReadHandler() {
            ...
            switch (cmos.reg) {
                ...
                default:
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_BIOS, LogSeverities.LOG_NORMAL, "CMOS:Read from reg " + Integer.toString(cmos.reg, 16));
                    return cmos.regs[cmos.reg];
            }
        }
    };
    ...
    static private void cmos_checktimer() {
        ...
        if (Log.level <= LogSeverities.LOG_NORMAL)
            Log.log(LogTypes.LOG_PIT, LogSeverities.LOG_NORMAL, "RTC Timer at " + StringHelper.format(1000.0 / cmos.timer.delay, 2) + " hz");
