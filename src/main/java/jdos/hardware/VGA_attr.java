                    ...
                    switch (VGA.vga.mode) {
                        case VGA.M_TEXT:
                            ...
                            if (val > 0x7)
                                ...
                                VGA.vga.config.pel_panning = (/*Bit8u*/short) (val + 1);
                            break;
                        case VGA.M_VGA:
                        case VGA.M_LIN8:
                ...
                default:
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL,
                            "VGA:ATTR:Write to unkown Index " + Integer.toString(VGA.vga.attr.index, 16));
                    break;
            }
        }
    };
    private static final IoHandler.IO_ReadHandler read_p3c1 = (port, iolen) -> {
        ...
        switch (VGA.vga.attr.index) {
            ...
            default:
                ...
                if (Log.level <= LogSeverities.LOG_NORMAL)
                    Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL,
                        "VGA:ATTR:Read from unkown Index " + Integer.toString(VGA.vga.attr.index, 16));
        }
        return 0;
    };
