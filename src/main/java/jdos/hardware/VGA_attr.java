...
public class VGA_attr {
    private static final IoHandler.IO_ReadHandler read_p3c0 = new IoHandler.IO_ReadHandler() {
    ...
    private static final IoHandler.IO_WriteHandler write_p3c0 = new IoHandler.IO_WriteHandler() {
            ...
            if (!VGA.vga.internal.attrindex) {
                ...
                */
                ...
                switch (VGA.vga.attr.index) {
                    ...
                    case 0x0e:
                    case 0x0f:
                        if ((VGA.vga.attr.disabled & 0x1) != 0)
                            VGA_ATTR_SetPalette(VGA.vga.attr.index, (/*Bit8u*/short) val);
                    /*
                    ...
                    case 0x10: { /* Mode Control Register */
                        ...
                        if ((difference & 0x04) != 0) {
                            ...
                            if (VGA.vga.mode == VGA.M_TEXT) {
                                /*Bit8u*/
                                int pan_reg = VGA.vga.attr.horizontal_pel_panning;
                                if (pan_reg > 7)
                    ...
                    */
                    ...
                    default:
                        ...
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:Write to unkown Index " + Integer.toString(VGA.vga.attr.index, 16));
                        break;
                }
            }
        }
    };
    private static final IoHandler.IO_ReadHandler read_p3c1 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            ...
            switch (VGA.vga.attr.index) {
                ...
                default:
                    ...
                    if (Log.level <= LogSeverities.LOG_NORMAL)
                        Log.log(LogTypes.LOG_VGAMISC, LogSeverities.LOG_NORMAL, "VGA:ATTR:Read from unkown Index " + Integer.toString(VGA.vga.attr.index, 16));
            }
            return 0;
        }
    };
