...
//    typedef Channel* ( DBOPL::Channel::*SynthHandler) ( Chip* chip, /*Bit32u*/long samples, /*Bit32s*/int* output );
    ...
    private static class Channel {
        ...
        void WriteA0(Chip chip, /*Bit8u*/int val) {
            /*Bit8u*/
            int fourOp = chip.reg104 & chip.opl3Active & fourMask;
            //Don't handle writes to silent fourop channels
            if (fourOp > 0x80)
                return;
            /*Bit32u*/
            long change = (chanData ^ val) & 0xff;
            if (change != 0) {
                chanData ^= change;
    ...
    private static class Chip {
        ...
        /*Bit32u*/int ForwardNoise() {
            ...
            /*Bitu*/
            long count = noiseCounter >> LFO_SH;
