...
public class Joystick extends Module_base {
    ...
    static private final IoHandler.IO_ReadHandler read_p201 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            ...
            short ret = 0xff;
            if (stick[0].enabled) {
                if (stick[0].xcount != 0) stick[0].xcount--;
                else ret &= ~1;
                if (stick[0].ycount != 0) stick[0].ycount--;
                else ret &= ~2;
                if (stick[0].button[0]) ret &= ~16;
                if (stick[0].button[1]) ret &= ~32;
            }
            if (stick[1].enabled) {
                if (stick[1].xcount != 0) stick[1].xcount--;
                else ret &= ~4;
                if (stick[1].ycount != 0) stick[1].ycount--;
                else ret &= ~8;
    ...
    static private final IoHandler.IO_ReadHandler read_p201_timed = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            /*Bit8u*/
            short ret = 0xff;
    ...
    static private final IoHandler.IO_WriteHandler write_p201 = new IoHandler.IO_WriteHandler() {
    ...
    static private final IoHandler.IO_WriteHandler write_p201_timed = new IoHandler.IO_WriteHandler() {
        public void call(/*Bitu*/int port, /*Bitu*/int val, /*Bitu*/int iolen) {
            // Store writetime index
