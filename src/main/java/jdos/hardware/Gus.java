...
public class Gus extends Module_base {
    ...
    private static final DMA.DMA_CallBack GUS_DMA_Callback = new DMA.DMA_CallBack() {
    ...
    private static final Section.SectionFunction GUS_ShutDown = new Section.SectionFunction() {
