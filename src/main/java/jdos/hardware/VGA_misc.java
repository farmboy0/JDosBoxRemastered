...
public class VGA_misc {
    ...
    private static final IoHandler.IO_WriteHandler write_p3c2 = new IoHandler.IO_WriteHandler() {
    ...
    private static final IoHandler.IO_ReadHandler read_p3cc = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
    ...
    private static final IoHandler.IO_ReadHandler read_p3ca = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return 0;
        }
    };

    private static final IoHandler.IO_ReadHandler read_p3c8 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            return 0x10;
        }
    };

    private static final IoHandler.IO_ReadHandler read_p3c2 = new IoHandler.IO_ReadHandler() {
        public /*Bitu*/int call(/*Bitu*/int port, /*Bitu*/int iolen) {
            /*Bit8u*/
            int retval = 0;
