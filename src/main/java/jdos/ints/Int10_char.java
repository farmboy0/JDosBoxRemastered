...
public class Int10_char {
    ...
    static void CGA2_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void CGA4_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void TANDY16_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void EGA16_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*PhysPt*/
        int src, dest;/*Bitu*/
        int copy;
        ...
        IoHandler.IO_Write(0x3cf, 1); /* Memory transfer mode */
        IoHandler.IO_Write(0x3c4, 2);
        IoHandler.IO_Write(0x3c5, 0xf); /* Enable all Write planes */
        /* Do some copying */
        /*Bitu*/
        int rowsize = cright - cleft;
        copy = cheight;
        for (; copy > 0; copy--) {
            for (/*Bitu*/int x = 0; x < rowsize; x++)
    ...
    static void VGA_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*PhysPt*/
        int src, dest;/*Bitu*/
        int copy;
    ...
    static void TEXT_CopyRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short rold, /*Bit8u*/short rnew,
        /*PhysPt*/int base) {
        /*PhysPt*/
        int src, dest;
    ...
    static void CGA2_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void CGA4_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void TANDY16_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
        /*PhysPt*/
    ...
    static void EGA16_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        ...
        int nextline = Int10_modes.CurMode.twidth;
        /*Bitu*/
        int copy = cheight;/*Bitu*/
        int rowsize = cright - cleft;
        for (; copy > 0; copy--) {
            for (/*Bitu*/int x = 0; x < rowsize; x++)
                Memory.mem_writeb(dest + x, 0xff);
            dest += nextline;
        }
        IoHandler.IO_Write(0x3cf, 0);
    }

    static void VGA_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        /* Write some bytes */
        /*Bit8u*/
        int cheight = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CHAR_HEIGHT);
    ...
    static void TEXT_FillRow(/*Bit8u*/short cleft, /*Bit8u*/short cright, /*Bit8u*/short row, /*PhysPt*/int base,
        /*Bit8u*/short attr) {
        /* Do some filing */
        /*PhysPt*/
        int dest;
    ...
    public static void INT10_ScrollWindow(/*Bit8u*/short rul, /*Bit8u*/short cul, /*Bit8u*/short rlr,
        /*Bit8u*/short clr, /*Bit8s*/byte nlines, /*Bit8u*/short attr, /*Bit8u*/short page) {
        ...
        if (page == 0xFF)
            page = (short) Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_PAGE);
        /*PhysPt*/
        ...
        if (Dosbox.machine == MachineType.MCH_PCJR) {
            if (Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_MODE) >= 9) {
                ...
                /*Bitu*/
                int cpupage = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CRTCPU_PAGE) >> 3 & 0x7;
        ...
        if (!gotofilling) {
            while (start != end) {
                ...
                switch (Int10_modes.CurMode.type) {
                    case VGA.M_TEXT:
                        TEXT_CopyRow(cul, clr, (short) start, (short) (start + nlines & 0xFF), base);
                        break;
                    case VGA.M_CGA2:
                        CGA2_CopyRow(cul, clr, (short) start, (short) (start + nlines & 0xFF), base);
                        break;
                    case VGA.M_CGA4:
                        CGA4_CopyRow(cul, clr, (short) start, (short) (start + nlines & 0xFF), base);
                        break;
                    case VGA.M_TANDY16:
                        TANDY16_CopyRow(cul, clr, (short) start, (short) (start + nlines & 0xFF), base);
                        break;
                    case VGA.M_EGA:
                        EGA16_CopyRow(cul, clr, (short) start, (short) (start + nlines & 0xFF), base);
                        break;
                    case VGA.M_VGA:
                    ...
                    default:
                        if (Log.level <= LogSeverities.LOG_ERROR)
                            Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                "Unhandled mode " + Int10_modes.CurMode.type + " for scroll");
                }
            }
        }
        /* Fill some lines */
    ...
    public static void INT10_SetActivePage(/*Bit8u*/short page) {
        ...
        if (page > 7)
            if (Log.level <= LogSeverities.LOG_ERROR)
                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR, "INT10_SetActivePage page " + page);

        if (Dosbox.IS_EGAVGA_ARCH() && Dosbox.svgaCard == SVGACards.SVGA_S3Trio)
            page &= 7;
...
//			if (Int10_modes.CurMode.mode>0x3) goto dowrite;	//Only mode 0-3 are text modes on cga
    ...
    public static void INT10_SetCursorPos(/*Bit8u*/short row, /*Bit8u*/short col, /*Bit8u*/short page) {
        /*Bit16u*/
        int address;

        if (page > 7)
            if (Log.level <= LogSeverities.LOG_ERROR)
                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR, "INT10_SetCursorPos page " + page);
        // Bios cursor pos
        ...
        /*Bit8u*/
        int current = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_PAGE);
        if (page == current) {
            // Get the dimensions
            /*BIOS_NCOLS*//*Bit16u*/
            int ncols = Memory.real_readw(Int10.BIOSMEM_SEG, Int10.BIOSMEM_NB_COLS);
    ...
    public static int ReadCharAttr(/*Bit16u*/int col, /*Bit16u*/int row, /*Bit8u*/short page) {
            ...
            default: /* EGA/VGA don't have a split font-table */
                for (/*Bit16u*/int chr = 0; chr <= 255; chr++) {
                    if (!split_chr || chr < 128)
                        ...
                        fontdata = Memory.Real2Phys(Memory.RealGetVec(0x1F)) + (chr - 128) * cheight;
                    ...
                    for (/*Bit8u*/short h = 0; h < cheight; h++) {
                        ...
                        short bitsel = 128;
                        /*Bit8u*/
                        int bitline = Memory.mem_readb(fontdata++);
                        /*Bit8u*/
                        short res = 0;
                        /*Bit8u*/
                        short vidline = 0;
    ...
    public static void WriteChar(/*Bit16u*/int col, /*Bit16u*/int row, /*Bit8u*/short page, /*Bit8u*/short chr,
        /*Bit8u*/short attr, boolean useattr) {
        /* Externally used by the mouse routine */
        /*RealPt*/
        int fontdata;
        /*Bitu*/
        ...
        if (!useattr) { //Set attribute(color) to a sensible value
            ...
            if (!warned_use) {
                if (Log.level <= LogSeverities.LOG_ERROR)
                    Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                        "writechar used without attribute in non-textmode " + (char) chr + " "
                            + Integer.toString(chr, 16));
                warned_use = true;
            }
            switch (Int10_modes.CurMode.type) {
                case VGA.M_CGA4:
        ...
        if (Int10_modes.CurMode.mode == 0x6/* || (Int10_modes.CurMode.mode==0x11)*/)
        ...
        for (/*Bit8u*/short h = 0; h < cheight; h++) {
            ...
            short bitsel = 128;
            /*Bit8u*/
            int bitline = Memory.mem_readb(Memory.Real2Phys(fontdata));
    ...
    public static void INT10_WriteChar(/*Bit8u*/short chr, /*Bit8u*/short attr, /*Bit8u*/short page,
        /*Bit16u*/int count, boolean showattr) {
        if (Int10_modes.CurMode.type != VGA.M_TEXT) {
    ...
    static void INT10_TeletypeOutputAttr(/*Bit8u*/short chr, /*Bit8u*/short attr, boolean useattr,
        /*Bit8u*/short page) {
        /*BIOS_NCOLS*//*Bit16u*/
        int ncols = Memory.real_readw(Int10.BIOSMEM_SEG, Int10.BIOSMEM_NB_COLS);
        /*BIOS_NROWS*//*Bit16u*/
...
//		cur_col=0; //Seems to break an old chess game
    ...
    public static void INT10_TeletypeOutputAttr(/*Bit8u*/int chr, /*Bit8u*/int attr, boolean useattr) {
        INT10_TeletypeOutputAttr((short) chr, (short) attr, useattr,
            (short) Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_PAGE));
    }
    ...
    public static void INT10_WriteString(/*Bit8u*/short row, /*Bit8u*/short col, /*sBit8u*/short flag,
        /*Bit8u*/short attr, /*PhysPt*/int string, /*Bit16u*/int count, /*Bit8u*/short page) {
        /*Bit8u*/
        short cur_row = Int10.CURSOR_POS_ROW(page);
        /*Bit8u*/
        short cur_col = Int10.CURSOR_POS_COL(page);
        ...
        while (count > 0) {
            /*Bit8u*/
            short chr = (short) Memory.mem_readb(string);
            string++;
            if ((flag & 2) != 0) {
