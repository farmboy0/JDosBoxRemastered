...
public class Int10 {
    ...
    public static Section.SectionFunction INT10_Destroy = section -> int10 = null;
    static boolean warned_ff = false;
    private static /*Bitu*/ int call_10;
    private static final Callback.Handler INT10_Handler = new Callback.Handler() {
        @Override
        ...
        public /*Bitu*/int call() {
                ...
                switch ((short) (CPU_Regs.reg_eax.high() & 0xFF)) {
                    ...
                    default:
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_NORMAL,
                                "Function AX:" + Integer.toString(CPU_Regs.reg_eax.word(), 16) + " , BX "
                                    + Integer.toString(CPU_Regs.reg_ebx.word(), 16) + " DX "
                                    + Integer.toString(CPU_Regs.reg_edx.word(), 16));
                        break;
                }
            }
            ...
            switch (c) {
                ...
                case 0x02: /* Set Cursor Pos */
                    Int10_char.INT10_SetCursorPos((short) CPU_Regs.reg_edx.high(), (short) CPU_Regs.reg_edx.low(),
                        (short) CPU_Regs.reg_ebx.high());
                    break;
                ...
                case 0x05: /* Set Active Page */
                    if ((CPU_Regs.reg_eax.low() & 0x80) != 0 && Dosbox.IS_TANDY_ARCH()) {
                        /*Bit8u*/
                        int crtcpu = Memory.real_readb(BIOSMEM_SEG, BIOSMEM_CRTCPU_PAGE);
                        switch (CPU_Regs.reg_eax.low()) {
                            ...
                            case 0x82:
                                ...
                                break;
                            case 0x83:
                                crtcpu = crtcpu & 0xc0 | CPU_Regs.reg_ebx.high() & 7
                                    | (CPU_Regs.reg_ebx.low() & 7) << 3;
                                break;
                        }
                        ...
                        Int10_char.INT10_SetActivePage((short) CPU_Regs.reg_eax.low());
                    break;
                case 0x06: /* Scroll Up */
                    Int10_char.INT10_ScrollWindow((short) CPU_Regs.reg_ecx.high(), (short) CPU_Regs.reg_ecx.low(),
                        (short) CPU_Regs.reg_edx.high(), (short) CPU_Regs.reg_edx.low(), (byte) -CPU_Regs.reg_eax.low(),
                        (short) CPU_Regs.reg_ebx.high(), (short) 0xFF);
                    break;
                ...
                case 0x09: /* Write Character & Attribute at cursor CX times */
                    if (Memory.real_readb(BIOSMEM_SEG, BIOSMEM_CURRENT_MODE) == 0x11) {
                        Int10_char.INT10_WriteChar((short) CPU_Regs.reg_eax.low(),
                            (short) (CPU_Regs.reg_ebx.low() & 0x80 | 0x3f), (short) CPU_Regs.reg_ebx.high(),
                            CPU_Regs.reg_ecx.word(), true);
                    } else {
                        Int10_char.INT10_WriteChar((short) CPU_Regs.reg_eax.low(), (short) CPU_Regs.reg_ebx.low(),
                            (short) CPU_Regs.reg_ebx.high(), CPU_Regs.reg_ecx.word(), true);
                    }
                    break;
                case 0x0A: /* Write Character at cursor CX times */
                    Int10_char.INT10_WriteChar((short) CPU_Regs.reg_eax.low(), (short) CPU_Regs.reg_ebx.low(),
                        (short) CPU_Regs.reg_ebx.high(), CPU_Regs.reg_ecx.word(), false);
                    break;
                ...
                case 0x0C: /* Write Graphics Pixel */
                    Int10_put_pixel.INT10_PutPixel(CPU_Regs.reg_ecx.word(), CPU_Regs.reg_edx.word(),
                        (short) CPU_Regs.reg_ebx.high(), (short) CPU_Regs.reg_eax.low());
                    break;
                case 0x0D: /* Read Graphics Pixel */
                    CPU_Regs.reg_eax.low(Int10_put_pixel.INT10_GetPixel(CPU_Regs.reg_ecx.word(),
                        CPU_Regs.reg_edx.word(), (short) CPU_Regs.reg_ebx.high()) & 0xFF);
                    break;
                ...
                case 0x0F: /* Get videomode */
                    ...
                    CPU_Regs.reg_eax.low((Memory.real_readb(BIOSMEM_SEG, BIOSMEM_CURRENT_MODE)
                        | Memory.real_readb(BIOSMEM_SEG, BIOSMEM_VIDEO_CTL) & 0x80) & 0xFF);
                    CPU_Regs.reg_eax.high(Memory.real_readw(BIOSMEM_SEG, BIOSMEM_NB_COLS) & 0xFF);
                    break;
                case 0x10: /* Palette functions */
                    if (!Dosbox.IS_EGAVGA_ARCH() && CPU_Regs.reg_eax.low() > 0x02)
                        break;
                    else if (!Dosbox.IS_VGA_ARCH() && CPU_Regs.reg_eax.low() > 0x03)
                        break;
                    switch (CPU_Regs.reg_eax.low()) {
                        case 0x00: /* SET SINGLE PALETTE REGISTER */
                            Int10_pal.INT10_SetSinglePaletteRegister((short) CPU_Regs.reg_ebx.low(),
                                (short) CPU_Regs.reg_ebx.high());
                            break;
                        ...
                        case 0x07: /* GET SINGLE PALETTE REGISTER */
                            CPU_Regs.reg_ebx
                                .high(Int10_pal.INT10_GetSinglePaletteRegister((short) CPU_Regs.reg_ebx.high(),
                                    (short) CPU_Regs.reg_ebx.low()) & 0xFF);
                            break;
                        ...
                        case 0x10: /* SET INDIVIDUAL DAC REGISTER */
                            Int10_pal.INT10_SetSingleDACRegister((short) CPU_Regs.reg_ebx.low(),
                                (short) CPU_Regs.reg_edx.high(), (short) CPU_Regs.reg_ecx.high(),
                                (short) CPU_Regs.reg_ecx.low());
                            break;
                        case 0x12: /* SET BLOCK OF DAC REGISTERS */
                            Int10_pal.INT10_SetDACBlock(CPU_Regs.reg_ebx.word(), CPU_Regs.reg_ecx.word(),
                                CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_edx.word());
                            break;
                        case 0x13: /* SELECT VIDEO DAC COLOR PAGE */
                            Int10_pal.INT10_SelectDACPage((short) CPU_Regs.reg_ebx.low(),
                                (short) CPU_Regs.reg_ebx.high());
                            break;
                        ...
                        case 0x17: /* GET BLOCK OF DAC REGISTER */
                            Int10_pal.INT10_GetDACBlock(CPU_Regs.reg_ebx.word(), CPU_Regs.reg_ecx.word(),
                                CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_edx.word());
                            break;
                        ...
                        default:
                            if (Log.level <= LogSeverities.LOG_ERROR)
                                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                    "Function 10:Unhandled EGA/VGA Palette Function "
                ...
                case 0x11: /* Character generator functions */
                    ...
                    switch (CPU_Regs.reg_eax.low()) {
                        ...
                        case 0x10:
                            Int10_memory.INT10_LoadFont(CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebp.word(),
                                CPU_Regs.reg_eax.low() == 0x10, CPU_Regs.reg_ecx.word(), CPU_Regs.reg_edx.word(),
                                CPU_Regs.reg_ebx.low(), CPU_Regs.reg_ebx.high());
                            break;
                        case 0x01: /* Load 8x14 font */
                        case 0x11:
                            Int10_memory.INT10_LoadFont(Memory.Real2Phys(int10.rom.font_14),
                                CPU_Regs.reg_eax.low() == 0x11, 256, 0, CPU_Regs.reg_ebx.low(), 14);
                            break;
                        case 0x02: /* Load 8x8 font */
                        case 0x12:
                            Int10_memory.INT10_LoadFont(Memory.Real2Phys(int10.rom.font_8_first),
                                CPU_Regs.reg_eax.low() == 0x12, 256, 0, CPU_Regs.reg_ebx.low(), 8);
                            break;
                        case 0x03: /* Set Block Specifier */
                            IoHandler.IO_Write(0x3c4, 0x3);
                            IoHandler.IO_Write(0x3c5, CPU_Regs.reg_ebx.low());
                            break;
                        case 0x04: /* Load 8x16 font */
                        case 0x14:
                            if (!Dosbox.IS_VGA_ARCH())
                                break;
                            Int10_memory.INT10_LoadFont(Memory.Real2Phys(int10.rom.font_16),
                                CPU_Regs.reg_eax.low() == 0x14, 256, 0, CPU_Regs.reg_ebx.low(), 16);
                            break;
                        /* Graphics mode calls */
                        ...
                        case 0x30:/* Get Font Information */
                            switch (CPU_Regs.reg_ebx.high()) {
                                ...
                                default:
                                    if (Log.level <= LogSeverities.LOG_ERROR)
                                        Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                            "Function 11:30 Request for font "
                                                + Integer.toString(CPU_Regs.reg_ebx.high(), 16));
                                    break;
                            }
                        ...
                        default:
                            if (Log.level <= LogSeverities.LOG_ERROR)
                                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                    "Function 11:Unsupported character generator call "
                                        + Integer.toString(CPU_Regs.reg_eax.low(), 16));
                            break;
                    }
                    break;
                case 0x12: /* alternate function select */
                    ...
                    switch (CPU_Regs.reg_ebx.low()) {
                        case 0x10: /* Get EGA Information */
                            CPU_Regs.reg_ebx.high(
                                Memory.real_readw(BIOSMEM_SEG, BIOSMEM_CRTC_ADDRESS) == 0x3B4 ? (byte) 1 : (byte) 0);
                        ...
                        case 0x30: /* Select vertical resolution */ {
                            ...
                            if (Log.level <= LogSeverities.LOG_WARN)
                                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_WARN, "Function 12:Call "
                                    + Integer.toString(CPU_Regs.reg_ebx.low(), 16) + " (select vertical resolution)");
                            ...
                            /*Bit8u*/
                            int modeset_ctl = Memory.real_readb(BIOSMEM_SEG, BIOSMEM_MODESET_CTL);
                            /*Bit8u*/
                            int video_switches = Memory.real_readb(BIOSMEM_SEG, BIOSMEM_SWITCHES) & 0xf0;
                            switch (CPU_Regs.reg_eax.low()) {
                                case 0: // 200
                                    modeset_ctl &= 0xef;
                                    modeset_ctl |= 0x80;
                        ...
                        case 0x31: /* Palette loading on modeset */ {
                            if (!Dosbox.IS_VGA_ARCH())
                                break;
                            if (Dosbox.svgaCard == SVGACards.SVGA_TsengET4K)
                            ...
                            /*Bit8u*/
                            short temp = (short) (Memory.real_readb(BIOSMEM_SEG, BIOSMEM_MODESET_CTL) & 0xf7);
                        ...
                        case 0x32: /* Video addressing */
                            if (!Dosbox.IS_VGA_ARCH())
                                break;
                            if (Log.level <= LogSeverities.LOG_ERROR)
                                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR, "Function 12:Call "
                                    + Integer.toString(CPU_Regs.reg_ebx.low(), 16) + " not handled");
                            if (Dosbox.svgaCard == SVGACards.SVGA_TsengET4K)
                                CPU_Regs.reg_eax.low(CPU_Regs.reg_eax.low() & 1);
                            if (CPU_Regs.reg_eax.low() > 1)
                                CPU_Regs.reg_eax.low(0); //invalid subfunction
                            else
                                CPU_Regs.reg_eax.low(0x12); //fake a success call
                            break;
                        case 0x33: /* SWITCH GRAY-SCALE SUMMING */ {
                            ...
                            /*Bit8u*/
                            short temp = (short) (Memory.real_readb(BIOSMEM_SEG, BIOSMEM_MODESET_CTL) & 0xfd);
                            if ((CPU_Regs.reg_eax.low() & 1) == 0)
                        ...
                        case 0x34: /* ALTERNATE FUNCTION SELECT (VGA) - CURSOR EMULATION */ {
                            ...
                            /*Bit8u*/
                            short temp = (short) (Memory.real_readb(BIOSMEM_SEG, BIOSMEM_VIDEO_CTL) & 0xfe);
                        ...
                        case 0x36: { /* VGA Refresh control */
                            ...
                            /*Bit8u*/
                            short clocking = IoHandler.IO_Read(0x3c5);
                ...
                case 0x13: /* Write String */
                    Int10_char.INT10_WriteString((short) CPU_Regs.reg_edx.high(), (short) CPU_Regs.reg_edx.low(),
                        (short) CPU_Regs.reg_eax.low(), (short) CPU_Regs.reg_ebx.low(),
                        CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebp.word(), CPU_Regs.reg_ecx.word(),
                        (short) CPU_Regs.reg_ebx.high());
                    break;
                case 0x1A: /* Display Combination */
                    ...
                    if (CPU_Regs.reg_eax.low() == 0) { // get dcc
                        // walk the tables...
                        /*RealPt*/
                        int vsavept = Memory.real_readd(BIOSMEM_SEG, BIOSMEM_VS_POINTER);
                        /*RealPt*/
                        ...
                        if (svstable != 0) {
                            ...
                            /*Bit8u*/
                            int entries = Memory.real_readb(Memory.RealSeg(dcctable), Memory.RealOff(dcctable) + 0x00);
                            /*Bit8u*/
                            int idx = Memory.real_readb(BIOSMEM_SEG, BIOSMEM_DCC_INDEX);
                            // check if index within range
                            if (idx < entries) {
                                /*Bit16u*/
                                int dccentry = Memory.real_readw(Memory.RealSeg(dcctable),
                ...
                case 0x1B: /* functionality State Information */
                    ...
                    switch (CPU_Regs.reg_ebx.word()) {
                        case 0x0000:
                            Int10_misc
                                .INT10_GetFuncStateInformation(CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_edi.word());
                            CPU_Regs.reg_eax.low(0x1B);
                            break;
                        default:
                            if (Log.level <= LogSeverities.LOG_ERROR)
                                Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                    "1B:Unhandled call BX " + Integer.toString(CPU_Regs.reg_ebx.word(), 16));
                            CPU_Regs.reg_eax.low(0);
                            break;
                    }
                    break;
                case 0x1C: /* Video Save Area */
                    ...
                    switch (CPU_Regs.reg_eax.low()) {
                        case 0: {
                            ...
                            break;
                        case 1:
                            if (Int10_video_state.INT10_VideoState_Save(CPU_Regs.reg_ecx.word(),
                                Memory.RealMake(CPU_Regs.reg_esVal.dword, CPU_Regs.reg_ebx.word())))
                                CPU_Regs.reg_eax.low(0x1c);
                            else
                                CPU_Regs.reg_eax.low(0);
                            break;
                        case 2:
                            if (Int10_video_state.INT10_VideoState_Restore(CPU_Regs.reg_ecx.word(),
                                Memory.RealMake(CPU_Regs.reg_esVal.dword, CPU_Regs.reg_ebx.word())))
                                CPU_Regs.reg_eax.low(0x1c);
                            else
                                CPU_Regs.reg_eax.low(0);
                ...
                case 0x4f: /* VESA Calls */
                    ...
                    switch ((short) (CPU_Regs.reg_eax.low() & 0xFF)) {
                        case 0x00: /* Get SVGA Information */
                            ...
                            CPU_Regs.reg_eax.high(
                                Int10_vesa.VESA_GetSVGAInformation(CPU_Regs.reg_esVal.dword, CPU_Regs.reg_edi.word()));
                            break;
                        case 0x01: /* Get SVGA Mode Information */
                            CPU_Regs.reg_eax.low(0x4f);
                            CPU_Regs.reg_eax.high(Int10_vesa.VESA_GetSVGAModeInformation(CPU_Regs.reg_ecx.word(),
                                CPU_Regs.reg_esVal.dword, CPU_Regs.reg_edi.word()));
                            break;
                        ...
                        case 0x05:
                            if (CPU_Regs.reg_ebx.high() == 0) { /* Set CPU Window */
                                CPU_Regs.reg_eax.high(Int10_vesa.VESA_SetCPUWindow((short) CPU_Regs.reg_ebx.low(),
                                    (short) CPU_Regs.reg_edx.low()));
                                CPU_Regs.reg_eax.low(0x4f);
                            } else if (CPU_Regs.reg_ebx.high() == 1) { /* Get CPU Window */
                                CPU_Regs.reg_eax.high(
                                    Int10_vesa.VESA_GetCPUWindow((short) CPU_Regs.reg_ebx.low(), CPU_Regs.reg_edx));
                                CPU_Regs.reg_eax.low(0x4f);
                            } else {
                                if (Log.level <= LogSeverities.LOG_ERROR)
                                    Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                        "Unhandled VESA Function " + Integer.toString(CPU_Regs.reg_eax.low(), 16)
                                            + " Subfunction " + Integer.toString(CPU_Regs.reg_ebx.high(), 16));
                        ...
                        case 0x06: {
                            ...
                            CPU_Regs.reg_eax.low(0x4f);
                            CPU_Regs.reg_eax.high(Int10_vesa.VESA_ScanLineLength((short) CPU_Regs.reg_ebx.low(),
                                CPU_Regs.reg_ecx.word(), bx, cx, dx));
                        ...
                        case 0x07:
                            switch ((short) (CPU_Regs.reg_ebx.low() & 0xFF)) {
                                ...
                                case 0x00: /* Set display Start */
                                    CPU_Regs.reg_eax.low(0x4f);
                                    CPU_Regs.reg_eax.high(Int10_vesa.VESA_SetDisplayStart(CPU_Regs.reg_ecx.word(),
                                        CPU_Regs.reg_edx.word()));
                                    break;
                                case 0x01: {
                                    IntRef cx = new IntRef(CPU_Regs.reg_ecx.word());
                                    IntRef dx = new IntRef(CPU_Regs.reg_edx.word());
                                ...
                                default:
                                    if (Log.level <= LogSeverities.LOG_ERROR)
                                        Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                            "Unhandled VESA Function " + Integer.toString(CPU_Regs.reg_eax.low(), 16)
                                                + " Subfunction " + Integer.toString(CPU_Regs.reg_ebx.low(), 16));
                        ...
                        case 0x09:
                            switch ((short) (CPU_Regs.reg_ebx.low() & 0xFF)) {
                                ...
                                case 0x00: /* Set Palette */
                                    CPU_Regs.reg_eax.high(
                                        Int10_vesa.VESA_SetPalette(CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_edi.word(),
                                            CPU_Regs.reg_edx.word(), CPU_Regs.reg_ecx.word()));
                                    CPU_Regs.reg_eax.low(0x4f);
                                    break;
                                case 0x01: /* Get Palette */
                                    CPU_Regs.reg_eax.high(
                                        Int10_vesa.VESA_GetPalette(CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_edi.word(),
                                            CPU_Regs.reg_edx.word(), CPU_Regs.reg_ecx.word()));
                                    CPU_Regs.reg_eax.low(0x4f);
                                    break;
                                default:
                    ...
                    break;
                case 0xf0:
                    CPU_Regs.reg_ebx.low(
                        Int10_misc.INT10_EGA_RIL_ReadRegister((short) CPU_Regs.reg_ebx.low(), CPU_Regs.reg_edx.word()));
                    break;
                case 0xf1:
                    CPU_Regs.reg_ebx.low(Int10_misc.INT10_EGA_RIL_WriteRegister((short) CPU_Regs.reg_ebx.low(),
                        (short) CPU_Regs.reg_ebx.high(), CPU_Regs.reg_edx.word()));
                    break;
                case 0xf2:
                    Int10_misc.INT10_EGA_RIL_ReadRegisterRange((short) CPU_Regs.reg_ecx.high(),
                        (short) CPU_Regs.reg_ecx.low(), CPU_Regs.reg_edx.word(),
                        CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebx.word());
                    break;
                case 0xf3:
                    Int10_misc.INT10_EGA_RIL_WriteRegisterRange((short) CPU_Regs.reg_ecx.high(),
                        (short) CPU_Regs.reg_ecx.low(), CPU_Regs.reg_edx.word(),
                        CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebx.word());
                    break;
                case 0xf4:
                    Int10_misc.INT10_EGA_RIL_ReadRegisterSet(CPU_Regs.reg_ecx.word(),
                        CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebx.word());
                    break;
                case 0xf5:
                    Int10_misc.INT10_EGA_RIL_WriteRegisterSet(CPU_Regs.reg_ecx.word(),
                        CPU_Regs.reg_esPhys.dword + CPU_Regs.reg_ebx.word());
                    break;
                case 0xfa: {
                    /*RealPt*/
                ...
                case 0xff:
                    if (!warned_ff)
                        Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_NORMAL, "INT10:FF:Weird NC call");
                    warned_ff = true;
                    break;
                default:
                    if (Log.level <= LogSeverities.LOG_ERROR)
                        Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                            "Function " + Integer.toString(CPU_Regs.reg_eax.word(), 16) + " not supported");
    ...
    public static Section.SectionFunction INT10_Init = section -> {
    ...
    static void graphics_chars() {
        switch (CPU_Regs.reg_ebx.low()) {
            case 0x00:
                Memory.real_writeb(BIOSMEM_SEG, BIOSMEM_NB_ROWS, (short) (CPU_Regs.reg_edx.low() - 1));
                break;
            case 0x01:
                Memory.real_writeb(BIOSMEM_SEG, BIOSMEM_NB_ROWS, (short) 13);
                break;
            case 0x03:
                Memory.real_writeb(BIOSMEM_SEG, BIOSMEM_NB_ROWS, (short) 42);
                break;
            case 0x02:
            default:
                Memory.real_writeb(BIOSMEM_SEG, BIOSMEM_NB_ROWS, (short) 24);
                break;
        }
    }
    ...
    private static void SetupTandyBios() {
        final byte[] TandyConfig = { 0x21, 0x42, 0x49, 0x4f, 0x53, 0x20, 0x52, 0x4f, 0x4d, 0x20, 0x76, 0x65, 0x72, 0x73,
            0x69, 0x6f, 0x6e, 0x20, 0x30, 0x32, 0x2e, 0x30, 0x30, 0x2e, 0x30, 0x30, 0x0d, 0x0a, 0x43, 0x6f, 0x6d, 0x70,
            0x61, 0x74, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x20, 0x53, 0x6f, 0x66, 0x74, 0x77, 0x61, 0x72, 0x65,
            0x0d, 0x0a, 0x43, 0x6f, 0x70, 0x79, 0x72, 0x69, 0x67, 0x68, 0x74, 0x20, 0x28, 0x43, 0x29, 0x20, 0x31, 0x39,
            0x38, 0x34, 0x2c, 0x31, 0x39, 0x38, 0x35, 0x2c, 0x31, 0x39, 0x38, 0x36, 0x2c, 0x31, 0x39, 0x38, 0x37, 0x0d,
            0x0a, 0x50, 0x68, 0x6f, 0x65, 0x6e, 0x69, 0x78, 0x20, 0x53, 0x6f, 0x66, 0x74, 0x77, 0x61, 0x72, 0x65, 0x20,
            0x41, 0x73, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x74, 0x65, 0x73, 0x20, 0x4c, 0x74, 0x64, 0x2e, 0x0d, 0x0a, 0x61,
    ...
    public static class VideoModeBlock {
        ...
        public VideoModeBlock(int mode, int type, int swidth, int sheight, int twidth, int theight, int cwidth,
            int cheight, int ptotal, int pstart, int plength, int htotal, int vtotal, int hdispend, int vdispend,
            int special) {
            this.mode = mode;
            this.type = type;
            this.swidth = swidth;
