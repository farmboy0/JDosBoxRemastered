                ...
                switch ((short) (CPU_Regs.reg_eax.high() & 0xFF)) {
                    ...
                    default:
                        if (Log.level <= LogSeverities.LOG_NORMAL)
                            Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_NORMAL, "Function AX:" + Integer.toString(CPU_Regs.reg_eax.word(), 16) + " , BX " + Integer.toString(CPU_Regs.reg_ebx.word(), 16) + " DX " + Integer.toString(CPU_Regs.reg_edx.word(), 16));
                        break;
                }
            }
            ...
            switch (c) {
                        ...
                        if (svstable != 0) {
                            ...
                            if (entries != 0) {
                                ...
                                for (ct = 0; ct < entries; ct++) {
                                    /*Bit16u*/
                                    int dccentry = Memory.real_readw(Memory.RealSeg(dcctable), Memory.RealOff(dcctable) + 0x04 + ct * 2);
                ...
                case 0x1C:    /* Video Save Area */
                    ...
                    switch (CPU_Regs.reg_eax.low()) {
                        ...
                        break;
                        case 1:
                            if (Int10_video_state.INT10_VideoState_Save(CPU_Regs.reg_ecx.word(), Memory.RealMake(CPU_Regs.reg_esVal.dword, CPU_Regs.reg_ebx.word())))
                                CPU_Regs.reg_eax.low(0x1c);
                            else CPU_Regs.reg_eax.low(0);
                            break;
                        case 2:
                            if (Int10_video_state.INT10_VideoState_Restore(CPU_Regs.reg_ecx.word(), Memory.RealMake(CPU_Regs.reg_esVal.dword, CPU_Regs.reg_ebx.word())))
                                CPU_Regs.reg_eax.low(0x1c);
                            else CPU_Regs.reg_eax.low(0);
                            break;
                        default:
