...
public class Int10_modes {
    public static final int _EGA_HALF_CLOCK = 0x0001;
    public static final int _EGA_LINE_DOUBLE = 0x0002;
    public static final int _VGA_PIXEL_DOUBLE = 0x0004;

    public static final int SEQ_REGS = 0x05;
    public static final int GFX_REGS = 0x09;
    public static final int ATT_REGS = 0x15;

    public static Int10.VideoModeBlock[] ModeList_VGA = {
        /* mode  ,type     ,sw  ,sh  ,tw ,th ,cw,ch ,pt,pstart  ,plength,htot,vtot,hde,vde special flags */
        new Int10.VideoModeBlock(0x000, VGA.M_TEXT, 360, 400, 40, 25, 9, 16, 8, 0xB8000, 0x0800, 50, 449, 40, 400,
            _EGA_HALF_CLOCK),
        new Int10.VideoModeBlock(0x001, VGA.M_TEXT, 360, 400, 40, 25, 9, 16, 8, 0xB8000, 0x0800, 50, 449, 40, 400,
            _EGA_HALF_CLOCK),
        ...
        new Int10.VideoModeBlock(0x004, VGA.M_CGA4, 320, 200, 40, 25, 8, 8, 1, 0xB8000, 0x4000, 50, 449, 40, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x005, VGA.M_CGA4, 320, 200, 40, 25, 8, 8, 1, 0xB8000, 0x4000, 50, 449, 40, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x006, VGA.M_CGA2, 640, 200, 80, 25, 8, 8, 1, 0xB8000, 0x4000, 100, 449, 80, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x007, VGA.M_TEXT, 720, 400, 80, 25, 9, 16, 8, 0xB0000, 0x1000, 100, 449, 80, 400, 0),

        new Int10.VideoModeBlock(0x00D, VGA.M_EGA, 320, 200, 40, 25, 8, 8, 8, 0xA0000, 0x2000, 50, 449, 40, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x00E, VGA.M_EGA, 640, 200, 80, 25, 8, 8, 4, 0xA0000, 0x4000, 100, 449, 80, 400,
            _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x00F, VGA.M_EGA, 640, 350, 80, 25, 8, 14, 2, 0xA0000, 0x8000, 100, 449, 80, 350,
            0), /*was EGA_2*/
        new Int10.VideoModeBlock(0x010, VGA.M_EGA, 640, 350, 80, 25, 8, 14, 2, 0xA0000, 0x8000, 100, 449, 80, 350, 0),
        new Int10.VideoModeBlock(0x011, VGA.M_EGA, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0xA000, 100, 525, 80, 480,
            0), /*was EGA_2 */
        ...
        new Int10.VideoModeBlock(0x054, VGA.M_TEXT, 1056, 688, 132, 43, 8, 16, 1, 0xB8000, 0x4000, 192, 800, 132, 688,
            0),
        new Int10.VideoModeBlock(0x055, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB8000, 0x2000, 192, 449, 132, 400,
            0),

        /* Alias of mode 101 */
        new Int10.VideoModeBlock(0x069, VGA.M_LIN8, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 100, 525, 80, 480, 0),
        /* Alias of mode 102 */
        new Int10.VideoModeBlock(0x06A, VGA.M_LIN4, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 128, 663, 100, 600,
            0),
        ...
        new Int10.VideoModeBlock(0x102, VGA.M_LIN4, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 132, 628, 100, 600,
            0),
        new Int10.VideoModeBlock(0x103, VGA.M_LIN8, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 132, 628, 100, 600,
            0),
        new Int10.VideoModeBlock(0x104, VGA.M_LIN4, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 168, 806, 128, 768,
            0),
        new Int10.VideoModeBlock(0x105, VGA.M_LIN8, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 168, 806, 128, 768,
            0),
        new Int10.VideoModeBlock(0x106, VGA.M_LIN4, 1280, 1024, 160, 64, 8, 16, 1, 0xA0000, 0x10000, 212, 1066, 160,
            1024, 0),
        new Int10.VideoModeBlock(0x107, VGA.M_LIN8, 1280, 1024, 160, 64, 8, 16, 1, 0xA0000, 0x10000, 212, 1066, 160,
            1024, 0),

        /* VESA text modes */
        new Int10.VideoModeBlock(0x108, VGA.M_TEXT, 640, 480, 80, 60, 8, 8, 2, 0xB8000, 0x4000, 100, 525, 80, 480, 0),
        new Int10.VideoModeBlock(0x109, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB8000, 0x2000, 160, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x10A, VGA.M_TEXT, 1056, 688, 132, 43, 8, 8, 1, 0xB8000, 0x4000, 160, 449, 132, 344,
            0),
        new Int10.VideoModeBlock(0x10B, VGA.M_TEXT, 1056, 400, 132, 50, 8, 8, 1, 0xB8000, 0x4000, 160, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x10C, VGA.M_TEXT, 1056, 480, 132, 60, 8, 8, 2, 0xB8000, 0x4000, 160, 531, 132, 480,
            0),

        /* VESA higher color modes */
        new Int10.VideoModeBlock(0x10D, VGA.M_LIN15, 320, 200, 40, 25, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 40, 400,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x10E, VGA.M_LIN16, 320, 200, 40, 25, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 40, 400,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x10F, VGA.M_LIN32, 320, 200, 40, 25, 8, 8, 1, 0xA0000, 0x10000, 50, 449, 40, 400,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x110, VGA.M_LIN15, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 200, 525, 80, 480,
            0),
        new Int10.VideoModeBlock(0x111, VGA.M_LIN16, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 200, 525, 80, 480,
            0),
        new Int10.VideoModeBlock(0x112, VGA.M_LIN32, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            0),
        new Int10.VideoModeBlock(0x113, VGA.M_LIN15, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 264, 628, 100, 600,
            0),
        new Int10.VideoModeBlock(0x114, VGA.M_LIN16, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 264, 628, 100, 600,
            0),
        new Int10.VideoModeBlock(0x115, VGA.M_LIN32, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 132, 628, 100, 600,
            0),

        new Int10.VideoModeBlock(0x116, VGA.M_LIN15, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 336, 806, 128, 768,
            0),
        new Int10.VideoModeBlock(0x117, VGA.M_LIN16, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 336, 806, 128, 768,
            0),
        new Int10.VideoModeBlock(0x118, VGA.M_LIN32, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 168, 806, 128, 768,
            0),
        ...
        new Int10.VideoModeBlock(0x150, VGA.M_LIN8, 320, 200, 40, 25, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x151, VGA.M_LIN8, 320, 240, 40, 30, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x152, VGA.M_LIN8, 320, 400, 40, 50, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x153, VGA.M_LIN8, 320, 480, 40, 60, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE),

        new Int10.VideoModeBlock(0x160, VGA.M_LIN15, 320, 240, 40, 30, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x161, VGA.M_LIN15, 320, 400, 40, 50, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x162, VGA.M_LIN15, 320, 480, 40, 60, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x165, VGA.M_LIN15, 640, 400, 80, 25, 8, 16, 1, 0xA0000, 0x10000, 200, 449, 160, 400,
            0),

        new Int10.VideoModeBlock(0x170, VGA.M_LIN16, 320, 240, 40, 30, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x171, VGA.M_LIN16, 320, 400, 40, 50, 8, 8, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x172, VGA.M_LIN16, 320, 480, 40, 60, 8, 8, 1, 0xA0000, 0x10000, 100, 525, 80, 480,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x175, VGA.M_LIN16, 640, 400, 80, 25, 8, 16, 1, 0xA0000, 0x10000, 200, 449, 160, 400,
            0),

        new Int10.VideoModeBlock(0x190, VGA.M_LIN32, 320, 240, 40, 30, 8, 8, 1, 0xA0000, 0x10000, 50, 525, 40, 480,
            _VGA_PIXEL_DOUBLE | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x191, VGA.M_LIN32, 320, 400, 40, 50, 8, 8, 1, 0xA0000, 0x10000, 50, 449, 40, 400,
            _VGA_PIXEL_DOUBLE),
        new Int10.VideoModeBlock(0x192, VGA.M_LIN32, 320, 480, 40, 60, 8, 8, 1, 0xA0000, 0x10000, 50, 525, 40, 480,
            _VGA_PIXEL_DOUBLE),

        /* S3 specific modes */
        new Int10.VideoModeBlock(0x207, VGA.M_LIN8, 1152, 864, 160, 64, 8, 16, 1, 0xA0000, 0x10000, 182, 948, 144, 864,
            0),
        new Int10.VideoModeBlock(0x209, VGA.M_LIN15, 1152, 864, 160, 64, 8, 16, 1, 0xA0000, 0x10000, 364, 948, 288, 864,
            0),
        new Int10.VideoModeBlock(0x20A, VGA.M_LIN16, 1152, 864, 160, 64, 8, 16, 1, 0xA0000, 0x10000, 364, 948, 288, 864,
            0),
        //new Int10.VideoModeBlock( 0x20B  ,VGA.M_LIN32	,1152,864,160,64 ,8 ,16 ,1 ,0xA0000 ,0x10000,182 ,948 ,144,864 ,0	),
        new Int10.VideoModeBlock(0x213, VGA.M_LIN32, 640, 400, 80, 25, 8, 16, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            0),

        /* Some custom modes */
        //new Int10.VideoModeBlock( 0x220  ,VGA.M_LIN32  ,1280,1024,160,64 ,8 ,16 ,1 ,0xA0000 ,0x10000,212 ,1066,160,1024,0	),
        // A nice 16:9 mode
        new Int10.VideoModeBlock(0x222, VGA.M_LIN8, 848, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 132, 525, 106, 480,
            0),
        new Int10.VideoModeBlock(0x223, VGA.M_LIN15, 848, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 264, 525, 212, 480,
            0),
        new Int10.VideoModeBlock(0x224, VGA.M_LIN16, 848, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 264, 525, 212, 480,
            0),
        new Int10.VideoModeBlock(0x225, VGA.M_LIN32, 848, 480, 80, 30, 8, 16, 1, 0xA0000, 0x10000, 132, 525, 106, 480,
            0),
    ...
    private static final Int10.VideoModeBlock[] ModeList_VGA_Text_200lines = {
        /* mode  ,type     ,sw  ,sh  ,tw ,th ,cw,ch ,pt,pstart  ,plength,htot,vtot,hde,vde special flags */
        new Int10.VideoModeBlock(0x000, VGA.M_TEXT, 320, 200, 40, 25, 8, 8, 8, 0xB8000, 0x0800, 50, 449, 40, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x001, VGA.M_TEXT, 320, 200, 40, 25, 8, 8, 8, 0xB8000, 0x0800, 50, 449, 40, 400,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x002, VGA.M_TEXT, 640, 200, 80, 25, 8, 8, 8, 0xB8000, 0x1000, 100, 449, 80, 400,
            _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x003, VGA.M_TEXT, 640, 200, 80, 25, 8, 8, 8, 0xB8000, 0x1000, 100, 449, 80, 400,
            _EGA_LINE_DOUBLE) };
    private static final Int10.VideoModeBlock[] ModeList_VGA_Text_350lines = {
        /* mode  ,type     ,sw  ,sh  ,tw ,th ,cw,ch ,pt,pstart  ,plength,htot,vtot,hde,vde special flags */
        new Int10.VideoModeBlock(0x000, VGA.M_TEXT, 320, 350, 40, 25, 8, 14, 8, 0xB8000, 0x0800, 50, 449, 40, 350,
            _EGA_HALF_CLOCK),
        new Int10.VideoModeBlock(0x001, VGA.M_TEXT, 320, 350, 40, 25, 8, 14, 8, 0xB8000, 0x0800, 50, 449, 40, 350,
            _EGA_HALF_CLOCK),
        new Int10.VideoModeBlock(0x002, VGA.M_TEXT, 640, 350, 80, 25, 8, 14, 8, 0xB8000, 0x1000, 100, 449, 80, 350, 0),
        new Int10.VideoModeBlock(0x003, VGA.M_TEXT, 640, 350, 80, 25, 8, 14, 8, 0xB8000, 0x1000, 100, 449, 80, 350,
            0) };
    private static final Int10.VideoModeBlock[] ModeList_VGA_Tseng = {
        ...
        new Int10.VideoModeBlock(0x018, VGA.M_TEXT, 1056, 688, 132, 44, 8, 8, 1, 0xB0000, 0x4000, 192, 800, 132, 704,
            0),
        new Int10.VideoModeBlock(0x019, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB0000, 0x2000, 192, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x01A, VGA.M_TEXT, 1056, 400, 132, 28, 8, 16, 1, 0xB0000, 0x2000, 192, 449, 132, 448,
            0),
        new Int10.VideoModeBlock(0x022, VGA.M_TEXT, 1056, 688, 132, 44, 8, 8, 1, 0xB8000, 0x4000, 192, 800, 132, 704,
            0),
        new Int10.VideoModeBlock(0x023, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB8000, 0x2000, 192, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x024, VGA.M_TEXT, 1056, 400, 132, 28, 8, 16, 1, 0xB8000, 0x2000, 192, 449, 132, 448,
            0),
        new Int10.VideoModeBlock(0x025, VGA.M_LIN4, 640, 480, 80, 30, 8, 16, 1, 0xA0000, 0xA000, 100, 525, 80, 480, 0),
        new Int10.VideoModeBlock(0x029, VGA.M_LIN4, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0xA000, 128, 663, 100, 600,
            0),
        ...
        new Int10.VideoModeBlock(0x02F, VGA.M_LIN8, 640, 400, 80, 25, 8, 16, 1, 0xA0000, 0x10000, 100, 449, 80, 400,
            0), /* ET4000 only */
        new Int10.VideoModeBlock(0x030, VGA.M_LIN8, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0x10000, 128, 663, 100, 600,
            0),
        new Int10.VideoModeBlock(0x036, VGA.M_LIN4, 960, 720, 120, 45, 8, 16, 1, 0xA0000, 0xA000, 120, 800, 120, 720,
            0), /* STB only */
        new Int10.VideoModeBlock(0x037, VGA.M_LIN4, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0xA000, 128, 800, 128, 768,
            0),
        new Int10.VideoModeBlock(0x038, VGA.M_LIN8, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 128, 800, 128, 768,
            0), /* ET4000 only */
        new Int10.VideoModeBlock(0x03D, VGA.M_LIN4, 1280, 1024, 160, 64, 8, 16, 1, 0xA0000, 0xA000, 160, 1152, 160,
            1024, 0), /* newer ET4000 */
        new Int10.VideoModeBlock(0x03E, VGA.M_LIN4, 1280, 960, 160, 60, 8, 16, 1, 0xA0000, 0xA000, 160, 1024, 160, 960,
            0), /* Definicon only */
        new Int10.VideoModeBlock(0x06A, VGA.M_LIN4, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0xA000, 128, 663, 100, 600,
            0), /* newer ET4000 */
    ...
    private static final Int10.VideoModeBlock[] ModeList_VGA_Paradise = {
        ...
        new Int10.VideoModeBlock(0x054, VGA.M_TEXT, 1056, 688, 132, 43, 8, 9, 1, 0xB0000, 0x4000, 192, 720, 132, 688,
            0),
        new Int10.VideoModeBlock(0x055, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB0000, 0x2000, 192, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x056, VGA.M_TEXT, 1056, 688, 132, 43, 8, 9, 1, 0xB0000, 0x4000, 192, 720, 132, 688,
            0),
        new Int10.VideoModeBlock(0x057, VGA.M_TEXT, 1056, 400, 132, 25, 8, 16, 1, 0xB0000, 0x2000, 192, 449, 132, 400,
            0),
        new Int10.VideoModeBlock(0x058, VGA.M_LIN4, 800, 600, 100, 37, 8, 16, 1, 0xA0000, 0xA000, 128, 663, 100, 600,
            0),
        new Int10.VideoModeBlock(0x05D, VGA.M_LIN4, 1024, 768, 128, 48, 8, 16, 1, 0xA0000, 0x10000, 128, 800, 128, 768,
            0), // documented only on C00 upwards
    ...
    private static final Int10.VideoModeBlock[] ModeList_EGA = {
        /* mode  ,type     ,sw  ,sh  ,tw ,th ,cw,ch ,pt,pstart  ,plength,htot,vtot,hde,vde special flags */
        new Int10.VideoModeBlock(0x000, VGA.M_TEXT, 320, 350, 40, 25, 8, 14, 8, 0xB8000, 0x0800, 50, 366, 40, 350,
            _EGA_HALF_CLOCK),
        new Int10.VideoModeBlock(0x001, VGA.M_TEXT, 320, 350, 40, 25, 8, 14, 8, 0xB8000, 0x0800, 50, 366, 40, 350,
            _EGA_HALF_CLOCK),
        ...
        new Int10.VideoModeBlock(0x004, VGA.M_CGA4, 320, 200, 40, 25, 8, 8, 1, 0xB8000, 0x4000, 60, 262, 40, 200,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x005, VGA.M_CGA4, 320, 200, 40, 25, 8, 8, 1, 0xB8000, 0x4000, 60, 262, 40, 200,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x006, VGA.M_CGA2, 640, 200, 80, 25, 8, 8, 1, 0xB8000, 0x4000, 120, 262, 80, 200,
            _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x007, VGA.M_TEXT, 720, 350, 80, 25, 9, 14, 8, 0xB0000, 0x1000, 120, 440, 80, 350, 0),

        new Int10.VideoModeBlock(0x00D, VGA.M_EGA, 320, 200, 40, 25, 8, 8, 8, 0xA0000, 0x2000, 60, 262, 40, 200,
            _EGA_HALF_CLOCK | _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x00E, VGA.M_EGA, 640, 200, 80, 25, 8, 8, 4, 0xA0000, 0x4000, 120, 262, 80, 200,
            _EGA_LINE_DOUBLE),
        new Int10.VideoModeBlock(0x00F, VGA.M_EGA, 640, 350, 80, 25, 8, 14, 2, 0xA0000, 0x8000, 96, 366, 80, 350,
            0), /*was EGA_2*/
    ...
    private static final Int10.VideoModeBlock[] ModeList_OTHER = {
        ...
        new Int10.VideoModeBlock(0xFFFF, VGA.M_ERROR, 0, 0, 0, 0, 0, 0, 0, 0x00000, 0x0000, 0, 0, 0, 0, 0), };
    private static final Int10.VideoModeBlock Hercules_Mode = new Int10.VideoModeBlock(0x007, VGA.M_TEXT, 640, 400, 80,
        25, 8, 14, 1, 0xB0000, 0x1000, 97, 25, 80, 25, 0);
    private static final byte[][] text_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x2a, 0x00 }, { 0x2a, 0x2a, 0x2a },
        { 0x00, 0x00, 0x15 }, { 0x00, 0x00, 0x3f }, { 0x00, 0x2a, 0x15 }, { 0x00, 0x2a, 0x3f }, { 0x2a, 0x00, 0x15 },
        { 0x2a, 0x00, 0x3f }, { 0x2a, 0x2a, 0x15 }, { 0x2a, 0x2a, 0x3f }, { 0x00, 0x15, 0x00 }, { 0x00, 0x15, 0x2a },
        { 0x00, 0x3f, 0x00 }, { 0x00, 0x3f, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x15, 0x2a }, { 0x2a, 0x3f, 0x00 },
        { 0x2a, 0x3f, 0x2a }, { 0x00, 0x15, 0x15 }, { 0x00, 0x15, 0x3f }, { 0x00, 0x3f, 0x15 }, { 0x00, 0x3f, 0x3f },
        { 0x2a, 0x15, 0x15 }, { 0x2a, 0x15, 0x3f }, { 0x2a, 0x3f, 0x15 }, { 0x2a, 0x3f, 0x3f }, { 0x15, 0x00, 0x00 },
        { 0x15, 0x00, 0x2a }, { 0x15, 0x2a, 0x00 }, { 0x15, 0x2a, 0x2a }, { 0x3f, 0x00, 0x00 }, { 0x3f, 0x00, 0x2a },
        { 0x3f, 0x2a, 0x00 }, { 0x3f, 0x2a, 0x2a }, { 0x15, 0x00, 0x15 }, { 0x15, 0x00, 0x3f }, { 0x15, 0x2a, 0x15 },
        { 0x15, 0x2a, 0x3f }, { 0x3f, 0x00, 0x15 }, { 0x3f, 0x00, 0x3f }, { 0x3f, 0x2a, 0x15 }, { 0x3f, 0x2a, 0x3f },
        { 0x15, 0x15, 0x00 }, { 0x15, 0x15, 0x2a }, { 0x15, 0x3f, 0x00 }, { 0x15, 0x3f, 0x2a }, { 0x3f, 0x15, 0x00 },
        { 0x3f, 0x15, 0x2a }, { 0x3f, 0x3f, 0x00 }, { 0x3f, 0x3f, 0x2a }, { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f },
        { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 },
        { 0x3f, 0x3f, 0x3f } };
    private static final byte[][] mtext_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f } };
    private static final byte[][] mtext_s3_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a },
        { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x2a, 0x2a, 0x2a }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f }, { 0x3f, 0x3f, 0x3f },
        { 0x3f, 0x3f, 0x3f } };
    private static final byte[][] ega_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a },
        ...
        { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 },
        { 0x3f, 0x3f, 0x3f }, { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f }, { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f },
        { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 }, { 0x3f, 0x3f, 0x3f }, { 0x00, 0x00, 0x00 },
        { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 }, { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a },
        { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a },
        { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f }, { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 },
        { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 }, { 0x3f, 0x3f, 0x3f }, { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f },
        { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 },
        { 0x3f, 0x3f, 0x3f } };
    private static final byte[][] cga_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a },
        { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f }, { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 },
        { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 }, { 0x3f, 0x3f, 0x3f }, };
    private static final byte[][] cga_palette_2 = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a },
        { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 }, { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 },
        { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a }, { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f },
        { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 },
        ...
        { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 }, { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 },
        { 0x3f, 0x3f, 0x3f }, };
    private static final byte[][] vga_palette = { { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x2a }, { 0x00, 0x2a, 0x00 },
        { 0x00, 0x2a, 0x2a }, { 0x2a, 0x00, 0x00 }, { 0x2a, 0x00, 0x2a }, { 0x2a, 0x15, 0x00 }, { 0x2a, 0x2a, 0x2a },
        { 0x15, 0x15, 0x15 }, { 0x15, 0x15, 0x3f }, { 0x15, 0x3f, 0x15 }, { 0x15, 0x3f, 0x3f }, { 0x3f, 0x15, 0x15 },
        { 0x3f, 0x15, 0x3f }, { 0x3f, 0x3f, 0x15 }, { 0x3f, 0x3f, 0x3f }, { 0x00, 0x00, 0x00 }, { 0x05, 0x05, 0x05 },
        { 0x08, 0x08, 0x08 }, { 0x0b, 0x0b, 0x0b }, { 0x0e, 0x0e, 0x0e }, { 0x11, 0x11, 0x11 }, { 0x14, 0x14, 0x14 },
        { 0x18, 0x18, 0x18 }, { 0x1c, 0x1c, 0x1c }, { 0x20, 0x20, 0x20 }, { 0x24, 0x24, 0x24 }, { 0x28, 0x28, 0x28 },
        { 0x2d, 0x2d, 0x2d }, { 0x32, 0x32, 0x32 }, { 0x38, 0x38, 0x38 }, { 0x3f, 0x3f, 0x3f }, { 0x00, 0x00, 0x3f },
        { 0x10, 0x00, 0x3f }, { 0x1f, 0x00, 0x3f }, { 0x2f, 0x00, 0x3f }, { 0x3f, 0x00, 0x3f }, { 0x3f, 0x00, 0x2f },
        { 0x3f, 0x00, 0x1f }, { 0x3f, 0x00, 0x10 }, { 0x3f, 0x00, 0x00 }, { 0x3f, 0x10, 0x00 }, { 0x3f, 0x1f, 0x00 },
        { 0x3f, 0x2f, 0x00 }, { 0x3f, 0x3f, 0x00 }, { 0x2f, 0x3f, 0x00 }, { 0x1f, 0x3f, 0x00 }, { 0x10, 0x3f, 0x00 },
        { 0x00, 0x3f, 0x00 }, { 0x00, 0x3f, 0x10 }, { 0x00, 0x3f, 0x1f }, { 0x00, 0x3f, 0x2f }, { 0x00, 0x3f, 0x3f },
        { 0x00, 0x2f, 0x3f }, { 0x00, 0x1f, 0x3f }, { 0x00, 0x10, 0x3f }, { 0x1f, 0x1f, 0x3f }, { 0x27, 0x1f, 0x3f },
        { 0x2f, 0x1f, 0x3f }, { 0x37, 0x1f, 0x3f }, { 0x3f, 0x1f, 0x3f }, { 0x3f, 0x1f, 0x37 }, { 0x3f, 0x1f, 0x2f },
        { 0x3f, 0x1f, 0x27 },

        { 0x3f, 0x1f, 0x1f }, { 0x3f, 0x27, 0x1f }, { 0x3f, 0x2f, 0x1f }, { 0x3f, 0x37, 0x1f }, { 0x3f, 0x3f, 0x1f },
        { 0x37, 0x3f, 0x1f }, { 0x2f, 0x3f, 0x1f }, { 0x27, 0x3f, 0x1f }, { 0x1f, 0x3f, 0x1f }, { 0x1f, 0x3f, 0x27 },
        { 0x1f, 0x3f, 0x2f }, { 0x1f, 0x3f, 0x37 }, { 0x1f, 0x3f, 0x3f }, { 0x1f, 0x37, 0x3f }, { 0x1f, 0x2f, 0x3f },
        { 0x1f, 0x27, 0x3f }, { 0x2d, 0x2d, 0x3f }, { 0x31, 0x2d, 0x3f }, { 0x36, 0x2d, 0x3f }, { 0x3a, 0x2d, 0x3f },
        { 0x3f, 0x2d, 0x3f }, { 0x3f, 0x2d, 0x3a }, { 0x3f, 0x2d, 0x36 }, { 0x3f, 0x2d, 0x31 }, { 0x3f, 0x2d, 0x2d },
        { 0x3f, 0x31, 0x2d }, { 0x3f, 0x36, 0x2d }, { 0x3f, 0x3a, 0x2d }, { 0x3f, 0x3f, 0x2d }, { 0x3a, 0x3f, 0x2d },
        { 0x36, 0x3f, 0x2d }, { 0x31, 0x3f, 0x2d }, { 0x2d, 0x3f, 0x2d }, { 0x2d, 0x3f, 0x31 }, { 0x2d, 0x3f, 0x36 },
        { 0x2d, 0x3f, 0x3a }, { 0x2d, 0x3f, 0x3f }, { 0x2d, 0x3a, 0x3f }, { 0x2d, 0x36, 0x3f }, { 0x2d, 0x31, 0x3f },
        { 0x00, 0x00, 0x1c }, { 0x07, 0x00, 0x1c }, { 0x0e, 0x00, 0x1c }, { 0x15, 0x00, 0x1c }, { 0x1c, 0x00, 0x1c },
        { 0x1c, 0x00, 0x15 }, { 0x1c, 0x00, 0x0e }, { 0x1c, 0x00, 0x07 }, { 0x1c, 0x00, 0x00 }, { 0x1c, 0x07, 0x00 },
        { 0x1c, 0x0e, 0x00 }, { 0x1c, 0x15, 0x00 }, { 0x1c, 0x1c, 0x00 }, { 0x15, 0x1c, 0x00 }, { 0x0e, 0x1c, 0x00 },
        { 0x07, 0x1c, 0x00 }, { 0x00, 0x1c, 0x00 }, { 0x00, 0x1c, 0x07 }, { 0x00, 0x1c, 0x0e }, { 0x00, 0x1c, 0x15 },
        { 0x00, 0x1c, 0x1c }, { 0x00, 0x15, 0x1c }, { 0x00, 0x0e, 0x1c }, { 0x00, 0x07, 0x1c },

        { 0x0e, 0x0e, 0x1c }, { 0x11, 0x0e, 0x1c }, { 0x15, 0x0e, 0x1c }, { 0x18, 0x0e, 0x1c }, { 0x1c, 0x0e, 0x1c },
        { 0x1c, 0x0e, 0x18 }, { 0x1c, 0x0e, 0x15 }, { 0x1c, 0x0e, 0x11 }, { 0x1c, 0x0e, 0x0e }, { 0x1c, 0x11, 0x0e },
        { 0x1c, 0x15, 0x0e }, { 0x1c, 0x18, 0x0e }, { 0x1c, 0x1c, 0x0e }, { 0x18, 0x1c, 0x0e }, { 0x15, 0x1c, 0x0e },
        { 0x11, 0x1c, 0x0e }, { 0x0e, 0x1c, 0x0e }, { 0x0e, 0x1c, 0x11 }, { 0x0e, 0x1c, 0x15 }, { 0x0e, 0x1c, 0x18 },
        { 0x0e, 0x1c, 0x1c }, { 0x0e, 0x18, 0x1c }, { 0x0e, 0x15, 0x1c }, { 0x0e, 0x11, 0x1c }, { 0x14, 0x14, 0x1c },
        { 0x16, 0x14, 0x1c }, { 0x18, 0x14, 0x1c }, { 0x1a, 0x14, 0x1c }, { 0x1c, 0x14, 0x1c }, { 0x1c, 0x14, 0x1a },
        { 0x1c, 0x14, 0x18 }, { 0x1c, 0x14, 0x16 }, { 0x1c, 0x14, 0x14 }, { 0x1c, 0x16, 0x14 }, { 0x1c, 0x18, 0x14 },
        { 0x1c, 0x1a, 0x14 }, { 0x1c, 0x1c, 0x14 }, { 0x1a, 0x1c, 0x14 }, { 0x18, 0x1c, 0x14 }, { 0x16, 0x1c, 0x14 },
        { 0x14, 0x1c, 0x14 }, { 0x14, 0x1c, 0x16 }, { 0x14, 0x1c, 0x18 }, { 0x14, 0x1c, 0x1a }, { 0x14, 0x1c, 0x1c },
        { 0x14, 0x1a, 0x1c }, { 0x14, 0x18, 0x1c }, { 0x14, 0x16, 0x1c }, { 0x00, 0x00, 0x10 }, { 0x04, 0x00, 0x10 },
        { 0x08, 0x00, 0x10 }, { 0x0c, 0x00, 0x10 }, { 0x10, 0x00, 0x10 }, { 0x10, 0x00, 0x0c }, { 0x10, 0x00, 0x08 },
        { 0x10, 0x00, 0x04 }, { 0x10, 0x00, 0x00 }, { 0x10, 0x04, 0x00 }, { 0x10, 0x08, 0x00 }, { 0x10, 0x0c, 0x00 },
        { 0x10, 0x10, 0x00 }, { 0x0c, 0x10, 0x00 }, { 0x08, 0x10, 0x00 }, { 0x04, 0x10, 0x00 },

        { 0x00, 0x10, 0x00 }, { 0x00, 0x10, 0x04 }, { 0x00, 0x10, 0x08 }, { 0x00, 0x10, 0x0c }, { 0x00, 0x10, 0x10 },
        { 0x00, 0x0c, 0x10 }, { 0x00, 0x08, 0x10 }, { 0x00, 0x04, 0x10 }, { 0x08, 0x08, 0x10 }, { 0x0a, 0x08, 0x10 },
        { 0x0c, 0x08, 0x10 }, { 0x0e, 0x08, 0x10 }, { 0x10, 0x08, 0x10 }, { 0x10, 0x08, 0x0e }, { 0x10, 0x08, 0x0c },
        { 0x10, 0x08, 0x0a }, { 0x10, 0x08, 0x08 }, { 0x10, 0x0a, 0x08 }, { 0x10, 0x0c, 0x08 }, { 0x10, 0x0e, 0x08 },
        { 0x10, 0x10, 0x08 }, { 0x0e, 0x10, 0x08 }, { 0x0c, 0x10, 0x08 }, { 0x0a, 0x10, 0x08 }, { 0x08, 0x10, 0x08 },
        { 0x08, 0x10, 0x0a }, { 0x08, 0x10, 0x0c }, { 0x08, 0x10, 0x0e }, { 0x08, 0x10, 0x10 }, { 0x08, 0x0e, 0x10 },
        { 0x08, 0x0c, 0x10 }, { 0x08, 0x0a, 0x10 }, { 0x0b, 0x0b, 0x10 }, { 0x0c, 0x0b, 0x10 }, { 0x0d, 0x0b, 0x10 },
        { 0x0f, 0x0b, 0x10 }, { 0x10, 0x0b, 0x10 }, { 0x10, 0x0b, 0x0f }, { 0x10, 0x0b, 0x0d }, { 0x10, 0x0b, 0x0c },
        { 0x10, 0x0b, 0x0b }, { 0x10, 0x0c, 0x0b }, { 0x10, 0x0d, 0x0b }, { 0x10, 0x0f, 0x0b }, { 0x10, 0x10, 0x0b },
        { 0x0f, 0x10, 0x0b }, { 0x0d, 0x10, 0x0b }, { 0x0c, 0x10, 0x0b }, { 0x0b, 0x10, 0x0b }, { 0x0b, 0x10, 0x0c },
        { 0x0b, 0x10, 0x0d }, { 0x0b, 0x10, 0x0f }, { 0x0b, 0x10, 0x10 }, { 0x0b, 0x0f, 0x10 }, { 0x0b, 0x0d, 0x10 },
        { 0x0b, 0x0c, 0x10 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 }, { 0x00, 0x00, 0x00 },
    ...
    private static void FinishSetMode(boolean clearmem) {
        ...
        if (clearmem) {
            switch (CurMode.type) {
                ...
                case VGA.M_TEXT: {
                    ...
                    for (/*Bit16u*/int ct = 0; ct < 16 * 1024; ct++)
                        Memory.real_writew(seg, ct * 2, 0x0720);
                    break;
                }
                case VGA.M_EGA:
                case VGA.M_VGA:
        ...
        Memory.real_writew(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CRTC_ADDRESS,
    ...
    public static boolean INT10_SetVideoMode_OTHER(/*Bit16u*/int mode, boolean clearmem) {
                ...
                if (!SetCurMode(ModeList_OTHER, mode)) {
                    if (Log.level <= LogSeverities.LOG_ERROR)
                        Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                            "Trying to set illegal mode " + Integer.toString(mode, 16));
                    return false;
                }
                break;
            case MachineType.MCH_HERC:
                // Only init the adapter if the equipment word is set to monochrome (Testdrive)
                if ((Memory.real_readw(Int10.BIOSMEM_SEG, Int10.BIOSMEM_INITIAL_MODE) & 0x30) != 0x30)
                    return false;
        ...
        if (Log.level <= LogSeverities.LOG_NORMAL)
            Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_NORMAL, "Set Video Mode " + Integer.toString(mode, 16));
...
//	VGA_SetMode(CurMode.type);
        ...
        for (/*Bit8u*/short ct = 0; ct < 16; ct++)
            VGA_dac.VGA_DAC_CombineColor(ct, ct);
        //Setup the special registers for each Dosbox.machine type
        final /*Bit8u*/ byte[] mode_control_list = { 0x2c, 0x28, 0x2d, 0x29, //0-3
            0x2a, 0x2e, 0x1e, 0x29, //4-7
            0x2a, 0x2b, 0x3b //8-a
        };
        final /*Bit8u*/ byte[] mode_control_list_pcjr = { 0x0c, 0x08, 0x0d, 0x09, //0-3
        ...
        switch (Dosbox.machine) {
            ...
            case MachineType.MCH_PCJR:
                ...
                if (CurMode.mode <= 0x04)
                    IO.IO_WriteB(0x3da, 0x02);
                else if (CurMode.mode == 0x06)
                    IO.IO_WriteB(0x3da, 0x08);
                else
                    IO.IO_WriteB(0x3da, 0x00);
...
//	Bit8u vga_switches=Memory.real_readb(Int10.BIOSMEM_SEG,BIOSMEM_SWITCHES);
        ...
        if (Dosbox.IS_VGA_ARCH()) {
            if (VGA.svga != null && VGA.svga.accepts_mode != null) {
                if (!VGA.svga.accepts_mode.call(mode))
                    return false;
            }
            ...
            switch (Dosbox.svgaCard) {
                ...
                case SVGACards.SVGA_TsengET3K:
                    if (!SetCurMode(ModeList_VGA_Tseng, mode)) {
                        if (Log.level <= LogSeverities.LOG_ERROR)
                            Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                                "VGA:Trying to set illegal mode " + Integer.toString(mode, 16));
                        return false;
                    }
                    break;
            ...
            if (!SetCurMode(ModeList_EGA, mode)) {
                if (Log.level <= LogSeverities.LOG_ERROR)
                    Log.log(LogTypes.LOG_INT10, LogSeverities.LOG_ERROR,
                        "EGA:Trying to set illegal mode " + Integer.toString(mode, 16));
                return false;
            }
        }
        ...
        if (Dosbox.machine == MachineType.MCH_EGA && (CurMode.special & _EGA_HALF_CLOCK) != 0)
            seq_data[1] |= 0x02;
        ...
        else if (CurMode.type == VGA.M_TEXT)
...
//dac_text16:
        ...
        /*Bit8u*/
        int feature = Memory.real_readb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_INITIAL_MODE);
        switch (CurMode.type) {
            case VGA.M_CGA2:
            ...
            case VGA.M_CGA4:
                feature = (short) (feature & ~0x30 | 0x20);
                if (CurMode.mode == 4)
                    Memory.real_writeb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_MSR, 0x2a);
                else if (CurMode.mode == 5)
                    Memory.real_writeb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_MSR, 0x2e);
                else
                    Memory.real_writeb(Int10.BIOSMEM_SEG, Int10.BIOSMEM_CURRENT_MSR, 0x2);
                break;
            case VGA.M_TANDY16:
                feature = (short) (feature & ~0x30 | 0x20);
                break;
...
//	Memory.real_writeb(Int10.BIOSMEM_SEG,Int10.BIOSMEM_INITIAL_MODE,feature);
    ...
    public static /*Bitu*/int VideoModeMemSize(/*Bitu*/int mode) {
        if (!Dosbox.IS_VGA_ARCH())
            return 0;
