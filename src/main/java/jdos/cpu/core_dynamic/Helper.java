...
public class Helper extends CPU_Regs {
    ...
    public static final int RESULT_ILLEGAL_INSTRUCTION = 1;
    public static final int RESULT_CALLBACK = 2;
    public static final int RESULT_CONTINUE = 3;
    public static final int RESULT_RETURN = 4;
    public static final int RESULT_ANOTHER = 5;
    public static final int RESULT_JUMP = 6;
    public static final int RESULT_CONTINUE_SEG = 7;
    ...
    protected static boolean EA16 = false;
    protected static int prefixes = 0;
    protected static int opcode_index = 0;

    // fetch the next byte of the instruction stream
    public static int decode_fetchbs() {
        return (byte) decode_fetchb();
    }

    public static int decode_fetchb() {
    ...
    public static void decode_putback(int count) {
    ...
    public static int decode_fetchws() {
        return (short) decode_fetchw();
    }

    // fetch the next word of the instruction stream
    public static int decode_fetchw() {
        if (decode.page.index >= 4095) {
            /*Bit16u*/
            int val = decode_fetchb();
            val |= decode_fetchb() << 8;
            return val;
        }
        if (decode.page.invmap != null
            && (decode.page.invmap.p[decode.page.index] >= 4 || decode.page.invmap.p[decode.page.index + 1] >= 4)) {
            decode.modifiedAlot = true;
        }
        decode.page.wmap.p[decode.page.index] += 0x01;
    ...
    public static int decode_fetchd() {
        ...
        if (decode.page.invmap != null && (decode.page.invmap.p[decode.page.index] >= 4
            || decode.page.invmap.p[decode.page.index + 1] >= 4 || decode.page.invmap.p[decode.page.index + 2] >= 4
            || decode.page.invmap.p[decode.page.index + 3] >= 4)) {
            decode.modifiedAlot = true;
        }
        decode.page.wmap.p[decode.page.index] += 0x01;
        decode.page.wmap.p[decode.page.index + 1] += 0x01;
