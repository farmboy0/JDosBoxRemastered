...
public class Grp3 extends Helper {
    ...
    static public class MulAxEd_mem extends Op {
        ...
        public String description() {
            return "MUL " + CPU_Regs.reg_eax.getName() + " " + CPU_Regs.reg_edx.getName() + ", " + get_eaa.description32();
        }
    }
    ...
    static public class DivAxEd_mem extends Op {
        ...
        public String description() {
            return "DIV " + CPU_Regs.reg_eax.getName() + " " + CPU_Regs.reg_edx.getName() + ", " + get_eaa.description32();
        }
    }
    ...
    static public class IDivAxEd_mem extends Op {
        ...
        public String description() {
            return "IDIV " + CPU_Regs.reg_eax.getName() + " " + CPU_Regs.reg_edx.getName() + ", " + get_eaa.description32();
        }
    }
}
