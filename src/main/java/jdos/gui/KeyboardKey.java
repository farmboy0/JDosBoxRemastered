...
public class KeyboardKey {
    public static final JavaMapper.DefaultKey[] DefaultKeys = { //
        ...
        new JavaMapper.DefaultKey("kp_multiply", 0xE37, false, false, true), //
        new JavaMapper.DefaultKey("kp_minus", 0xE4A, false, false, true), //
        new JavaMapper.DefaultKey("kp_plus", 0xE4E, false, false, true), //
