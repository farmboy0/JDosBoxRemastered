...
public class MainBase {
    ...
    private static final Section.SectionFunction GUI_ShutDown = new Section.SectionFunction() {
    ...
    private static final Mapper.MAPPER_Handler KillSwitch = new Mapper.MAPPER_Handler() {
    ...
    private static final Mapper.MAPPER_Handler CaptureMouse = new Mapper.MAPPER_Handler() {
        public void call(boolean pressed) {
            if (pressed) {
                GFX_CaptureMouse();
            }
    ...
    private static final Mapper.MAPPER_Handler SwitchFullScreen = new Mapper.MAPPER_Handler() {
        public void call(boolean pressed) {
            if (pressed)
                gui.fullScreenToggle();
        }
    };
    private static final Mapper.MAPPER_Handler PauseDOSBox = new Mapper.MAPPER_Handler() {
        public void call(boolean pressed) {
            if (!pressed) {
                return;
            }
    ...
    static void main(GUI g, String[] args) {
        ...
        while (true) {
            ...
            ((MainFrame) gui).frame.setLocation(new Point(((Section_prop) Dosbox.control.GetSection("sdl")).Get_int("posx"), ((Section_prop) Dosbox.control.GetSection("sdl")).Get_int("posy")));
