...
public class testHeap extends InstructionsTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        CPU.cpu.pmode = true;
//        CPU.Segs_CSval = 0x08; todo: find out why this field does not exist
    ...
    public void testPageFault() {
        ...
        final KernelHeap heap = new KernelHeap(memory, memory.kernel_directory, 0xD0000000, 0xD0001000, 0xD0002000,
            false, false);
